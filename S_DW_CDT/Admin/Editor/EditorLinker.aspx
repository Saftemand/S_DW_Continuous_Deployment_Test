...
<html>
  ...
  <body MS_POSITIONING="GridLayout" scroll="no" style="OVERFLOW: hidden">
		...
		<tr>
			<td>
				<table cellSpacing="0" cellPadding="0" align="center" border="0">
					<tr>
						<td>
							<%=Gui.LinkManager("", "PageShortCut", "", "0", Base.ChkNumber(Session("DW_Area")), False, True, True, "", True, True)%>
						</td>
					</tr>
					<tr id="rowSubmit" style="display:">
						<td>
							<br />
							<%=Gui.Button(Translate.Translate("OK"), "internalNewEditor();", 0)%>
						</td>
					</tr>
				</table>
			</td>
