...
<body>
		...
		<div>
			<dw:Toolbar ID="Toolbar1" runat="server">
				<dw:ToolbarButton ID="ToolbarButton1" KeyboardShortcut="ctrl+s" runat="server" Divide="None" Image="Save" Text="Gem" OnClientClick="save(false);">
				</dw:ToolbarButton>
				<dw:ToolbarButton ID="ToolbarButton2" runat="server" Divide="None" Image="SaveAndClose" Text="Gem og luk" OnClientClick="save(true);">
				</dw:ToolbarButton>
				<dw:ToolbarButton ID="ToolbarButton3" runat="server" Divide="None" Image="SaveAs" Text="Gem som" OnClientClick="dialog.show('SaveAsDialog');">
				</dw:ToolbarButton>
				<dw:ToolbarButton ID="cmdExtendedEditor" Image="EditDocument" Divide="Before" Text="Extended editor" OnClientClick="switchView();" runat="server" />
			</dw:Toolbar>
			<h2 class="subtitle">
				<%=Dynamicweb.Base.Request("Folder")%>/<%=Dynamicweb.Base.Request("File")%>
			</h2>
		</div>
		...
		<dw:Dialog ID="SaveAsDialog" runat="server" Title="Gem som" CancelAction="dialog.hide('SaveAsDialog');" ShowCancelButton="true" ShowOkButton="true" OkAction="saveAs();">
			...
			<tr>
				...
				<td><input type="text" name="Folder" value="<%=Dynamicweb.Base.Request("Folder")%>" id="Folder" class="std" readonly="readonly" /></td>
			</tr>
			<tr>
				<td><dw:TranslateLabel id="lbFileLabel" runat="server" Text="File" /></td>
				<td><input type="text" name="File" value="<%=Dynamicweb.Base.Request("File")%>" id="File" class="std" /></td>
			</tr>
			<tr>
				<td></td>
				<td>
