...
Dynamicweb.Controls.RulesEditor.LinkSelectorCtrl = function (id, val, onChange) {
...
Dynamicweb.Controls.RulesEditor.DateTimeCtrl = function (id, val, nameOfMonths, onChange, showTime) {
    ...
    if (id != "") {
        ...
        result.innerHTML =  '<div id="' + id + '_DateTime" class="date-selector">' +
                            ...
                            '<input type="text" id="' + id + '_DateView" class="date-selector-label" value="' + displayedDate + '"></input>' +
