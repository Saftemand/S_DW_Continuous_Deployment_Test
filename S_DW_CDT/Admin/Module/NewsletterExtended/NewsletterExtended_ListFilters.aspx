<%@ Page CodeBehind="NewsletterExtended_ListFilters.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="Dynamicweb.Admin.NewsletterExtended_ListFilters" %>
...
<table cellpadding=0 cellspacing=0 border=0 class=cleantable  style="margin:0px;" width="100%">
	...
	For j = 0 To categoryView.count - 1
		If CShort(PositionCount) >= CShort(Position) And CShort(PositionCount) < CShort(PositionNext) Then
			...
			End If
			response.Write("</td>")
			response.Write("<td valign='middle'><a href=""JavaScript:DeleteRecipient('" & categoryView(j)("NewsletterID").ToString & "')"">" & vbNewLine & "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src=""../../images/Delete.gif"" border=""0"" width=""15"" height=""17"" alt=""" & Translate.Translate("Slet %%?", "%%", Translate.JSTranslate("nyhedsbrev")) & """></a>" & vbNewLine & "</td>" & vbNewLine & "</tr>")
		End If
