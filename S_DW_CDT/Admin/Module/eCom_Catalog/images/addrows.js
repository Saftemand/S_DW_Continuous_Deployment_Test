...
try {
	...
	var Stock6		= '<input type="text" maxlength="255" name="STCKS_Icon#DWCNT#" value="" size="25"> <img src="/Admin/Images/Browse.gif" onClick="browseArchive(\'STCKS_Icon#DWCNT#\', \'\', document.all.STCKS_Icon#DWCNT#.value);" align=absMiddle class=H>';
} catch(e) {
	//Nothing
}	
...
try {
	var PropGrp1	= '<input type="hidden" name="PROPGRP_ID#DWCNT#" value="-1"><input type=hidden name=PROPGRP_LineID#DWCNT# value=#DWCNT#><input type=hidden name=DETAIL_Type#DWCNT# value=0><input type="text" maxlength="255" name="PROPGRP_Name#DWCNT#" value="" style="width:100%">';
	var PropFld1	= '<input type="hidden" name="PROPFLD_ID#DWCNT#" value="-1"><input type=hidden name=PROPFLD_LineID#DWCNT# value=#DWCNT#><input type=hidden name=DETAIL_Type#DWCNT# value=0><input type="text" maxlength="255" name="PROPFLD_Label#DWCNT#" value="" style="width:100%">';
	var PropFld2	= PROPFLD_InputTypeValues;
	var PropOpt1	= '<input type="hidden" name="PROPOPTION_ID#DWCNT#" value="-1"><input type=hidden name=PROPOPTION_LineID#DWCNT# value=#DWCNT#><input type=hidden name=DETAIL_Type#DWCNT# value=0><input type="text" maxlength="255" name="PROPOPTION_Text#DWCNT#" value="" style="width:100%">';
} catch(e) {
	//Nothing
}		
