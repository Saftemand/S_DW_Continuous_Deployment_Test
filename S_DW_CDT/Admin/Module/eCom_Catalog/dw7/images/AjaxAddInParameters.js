...
function getParameters(discounttype, group, id, divname, pageId) {
    ...
    xhttp.open("GET", "/Admin/Module/eCom_Catalog/dw7/Edit/EcomConfigurableAddin_GetParameters.aspx?type=" + discounttype + "&id=" + id + params, true);
...
function updateParameters(sender, divname, id, pageId) {
    updateParametersInGroup(sender, divname, "", id, pageId)

}

function updateParametersInGroup(sender, divname, group, id, pageId) {
    ...
    if (selected.value.length > 0) {
        ...
        getParameters(selected.value, group, id, divname, pageId);
    }
    else {
