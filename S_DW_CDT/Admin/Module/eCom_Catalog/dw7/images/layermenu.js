...
function selectCountry(countryID) {
	...
	if (countryID == "-1") {
		parent.ContentFrame.location.href = "../Edit/EcomCountry_Edit.aspx?addAll=yes";
	} else {
		parent.ContentFrame.location.href = "../Edit/EcomCountry_Edit.aspx?autocreate="+ countryID;
	}
}		