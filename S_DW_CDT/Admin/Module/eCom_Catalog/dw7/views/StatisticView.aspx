...
<asp:Content ID="cHead" ContentPlaceHolderID="HeadHolder" runat="server">
    <script type="text/javascript" language="JavaScript" src="../images/AjaxAddInParameters.js"></script>
		<script type="text/javascript" language="JavaScript" src="/Admin/Module/Seo/Chart/JSClass/FusionCharts.js"></script>
...
<asp:Content ID="cContent" ContentPlaceHolderID="ContentHolder" runat="server">
	...
	<dw:RibbonBar ID="chartRibbon" HelpKeyword="ecom.statistics.view" runat="server">
	    <dw:RibbonBarTab ID="tabChart" Name="Chart" runat="server">
	        <dw:RibbonBarGroup ID="groupData" Name="Data" runat="server">
	            <dw:RibbonBarButton ID="cmdChartType" Text="Chart type" Size="Large" Image="ColumnChart" ContextMenuId="cmChartType" SplitButton="false" runat="server" />
	            <dw:RibbonBarCheckbox ID="chkShowList" Checked="false" Text="Show list" OnClientClick="ShowData();" Size="Small" Image="View" runat="server" />
	            <dw:RibbonBarButton ID="cmdSave" Text="Apply parameters" EnableServerClick="true" OnClick="cmdSave_Click" Image="Check" Size="Small" runat="server" />
	        </dw:RibbonBarGroup>
	        <dw:RibbonBarGroup ID="groupExport" Name="Export" runat="server">
	            <dw:RibbonBarButton ID="cmdExportXLS" Text="Export to Excel" Size="Small" Image="Export" OnClientClick="exportStat();" runat="server" />
	            <dw:RibbonBarButton ID="cmdPrint" Text="Printable version" Size="Small" Image="Print" OnClientClick="printStat();" runat="server" />
	        </dw:RibbonBarGroup>
	    </dw:RibbonBarTab>
	</dw:RibbonBar>
    ...
    <dw:ContextMenu ID="cmChartType" runat="server">
        <dw:ContextMenuButton ID="cmdLineChart" Text="Line chart" Image="LineChart" OnClientClick="changeView('LINE');" runat="server" />
        <dw:ContextMenuButton ID="cmdPieChart" Text="Pie chart" Image="PieChart" OnClientClick="changeView('PIE');" runat="server" />
        <dw:ContextMenuButton ID="cmdColumnChart" Text="Column chart" Image="ColumnChart" Checked="true" OnClientClick="changeView('COLUMN');" runat="server" />
    </dw:ContextMenu>
