...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function help(){
		    <%=Dynamicweb.Gui.Help("", "ecom.rma.edit", "en") %>
	    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentHolder" runat="server">
        ...
        <dw:RibbonBar ID="RibbonBar" runat="server">
            <dw:RibbonBarTab ID="RibbonBarTab1" Name="RMA" runat="server">
                <dw:RibbonBarGroup ID="RibbonBarGroup1" Name="Tools" runat="server">
                    <dw:RibbonBarButton ID="btnSave" Text="Save" Image="Save" Size="Small" runat="server" ShowWait="true"
                        EnableServerClick="true" OnClick="Ribbon_Save">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="btnSaveAndClose" Text="Save and close" Image="SaveAndClose" Size="Small" runat="server" ShowWait="true"
                        EnableServerClick="true" OnClick="Ribbon_SaveAndClose">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="btnCancel" Text="Cancel" Image="Cancel" Size="Small"
                        runat="server" EnableServerClick="true" OnClick="Ribbon_Cancel">
                    </dw:RibbonBarButton>
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="rbgFinalize" Name="Finalize" runat="server">
                    <dw:RibbonBarButton ID="btnClose" Text="Close" Image="DeleteDocument" Size="Small"
                        runat="server" EnableServerClick="true" OnClientClick=" if(!confirm(_closeQuestion)) {return false;} " OnClick="Ribbon_CloseRMA">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="btnDelete" Text="Delete" Image="Delete" Size="Small"
                ...
                <dw:RibbonBarGroup ID="RibbonBarGroup5" Name="Show" runat="server">
                    <dw:RibbonBarRadioButton ID="btnRma" Text="RMA" ImagePath="/Admin/Images/eCom/eCom_RMA.png" Size="Large"
                        runat="server" Group="ShowEdit" OnClientClick="toggleUserInfoEdit('view');" Checked="true" />
                    <dw:RibbonBarRadioButton ID="btnUserInfo" Text="User info" Image="User" Size="Large"
                ...
                <dw:RibbonBarGroup ID="rbgReplacementOrder" Name="Replacement order" runat="server">
                    <dw:RibbonBarButton ID="btnPerformAction" Text="Create order" Image="Convert" Size="Large" runat="server" OnClientClick="showPerformActionDialog();">
                    </dw:RibbonBarButton>
                </dw:RibbonBarGroup>
    ...
    <dw:Dialog runat="server" ID="rmaActionDialog" IsModal="true" ShowOkButton="true" ShowCancelButton="true" ShowClose="false" 
        Title="Create replacement order" UseTabularLayout="true" OkAction="performAction();" CancelAction="dialog.hide('rmaActionDialog');" Width="600">
