...
<body>
    <form id="form1" runat="server">
        <div id="ListPanel">
            <dw:Toolbar runat="server" ID="Toolbar" ShowEnd="false">
                <dw:ToolbarButton runat="server" ID="btnClose" Image="Cancel" Text="Close" OnClientClick="opener.location.reload(); window.close();" />
            </dw:Toolbar>
    ...
    <script type="text/javascript">
			var orderProcessingMessage = "<%= Base.JSEnable(orderProcessingMessage) %>";
      var processingCompletedMessage = "<%= Base.JSEnable(processingCompletedMessage) %>";
    </script>
</body>
