                    ...
                    <asp:TemplateField ItemStyle-Width="16px">
                        <ItemTemplate>
                            <div id="buttons" style="visibility: hidden; width: 16px;">
                                <img alt="<%=Translate.JsTranslate("Slet") %>" src="/Admin/images/Delete_small.gif" onclick="javascript:deleteOptionRow(this);" />
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
