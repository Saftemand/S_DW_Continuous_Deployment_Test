...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .columnsDiv{
            margin: 5px;position:absolute; right: 3px;top: 83px;bottom: 10px;left: 0px;
        }
        .columnsDiv.top{
            top: 33px !important;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <dw:Toolbar ID="ToolbarButtons" runat="server" ShowEnd="false">
            <dw:ToolbarButton runat="server" ID="btnExport" ImagePath="/Admin/Module/IntegrationV2/img/run_activity_small.png" Text="Export users" OnClientClick="showOverlay();exportUsers();" />
        </dw:Toolbar>
