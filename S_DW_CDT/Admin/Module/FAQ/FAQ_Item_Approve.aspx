<%@ Page CodeBehind="FAQ_Item_Approve.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="Dynamicweb.Admin.FAQ_Item_Approve" %>
...
If LCase(Request.QueryString.Item("Immediate")) = "true" Then
	FAQItemCategoryID = cWorkflow.Approve("FAQItemCategoryID")
Else
	FAQItemCategoryID = cWorkflow.ApproveStep("FAQItemCategoryID")
End If
