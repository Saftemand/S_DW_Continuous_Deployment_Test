...
<dw:GroupBox ID="Groups" runat="server" Title="Groups" DoTranslation="true">
	<table>
		...
		<tr>
			...
			<td>
				<label>
					<input type="checkbox" id="LocationGroupsUseSubgroups" runat="server"/>
					<dw:TranslateLabel runat="server" Text="Use only subgroups" />
				</label>
			</td>
		</tr>
	</table>
...
<dw:GroupBox ID="MapSettings" runat="server" Title="Map Settings" DoTranslation="true">
	<table>
		<tr>
			...
			<td>
				<label for="MapWidth">
					<dw:TranslateLabel runat="server" Text="Width" /></label>
				<input type="text" id="MapWidth" size="8" runat="server" class="std length"/>
				<label for="MapHeight">
					<dw:TranslateLabel runat="server" Text="Height" /></label>
		...
		<tr>
			<td class="leftColHigh">
				<label for="MapType">
					<dw:TranslateLabel runat="server" Text="Map type" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="MapZoomLevel">
					<dw:TranslateLabel runat="server" Text="Zoom level" /></label>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<label for="MapCenterLat">
					<dw:TranslateLabel runat="server" Text="Lat" /></label>
				<input type="text" id="MapCenterLat" size="8" runat="server" class="std number"/>
				<label for="MapCenterLng">
					<dw:TranslateLabel runat="server" Text="Lng" /></label>
				<input type="text" id="MapCenterLng" size="8" runat="server" class="std number"/>
				<button type="button" id="GeoLocationShowOnMap">
					<dw:TranslateLabel runat="server" Text="Show location on map" /></button>
			</td>
		</tr>
	</table>
</dw:GroupBox>
		...
		<tr>
			<td class="leftColHigh">
				<label for="MarkerImage">
					<dw:TranslateLabel runat="server" Text="Marker Image" /></label>
			</td>
			<td>
				<dw:FileManager id="MarkerImage" runat="server" Extensions="jpg,png" FullPath="true" />
			</td>
		</tr>
	</table>
</dw:GroupBox>
<dw:GroupBox ID="ClustererSettings" runat="server" Title="Clusterer Settings" DoTranslation="true">
	<table>
		<tr>
			...
			<td>
				<label>
					<input id="ClustererEnabled" value="1" runat="server" type="checkbox" />
					<dw:TranslateLabel runat="server" Text="Enable Clusterer" />
				</label>
			</td>
		</tr>
	</table>
	<table id="ClustererSettingsUI">
		<% If False Then%>
		<tr>
			<td class="leftColHigh">
				<label for="ClustererGridSize">
					<dw:TranslateLabel runat="server" Text="Clusterer Grid Size" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterSmallImage">
					<dw:TranslateLabel runat="server" Text="Small Cluster Image" /></label>
			</td>
			<td>
				<dw:FileManager id="ClustererClusterSmallImage" runat="server" Extensions="jpg,png" FullPath="true" />
			</td>
		</tr>
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterSmallTextColor">
					<dw:TranslateLabel runat="server" Text="Small Cluster Text Color" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterSmallTextSize">
					<dw:TranslateLabel runat="server" Text="Small Cluster Text Size" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterMediumImage">
					<dw:TranslateLabel runat="server" Text="Medium Cluster Image" /></label>
			</td>
			<td>
				<dw:FileManager id="ClustererClusterMediumImage" runat="server" Extensions="jpg,png" FullPath="true" />
			</td>
		</tr>
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterMediumTextColor">
					<dw:TranslateLabel runat="server" Text="Medium Cluster Text Color" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterMediumTextSize">
					<dw:TranslateLabel runat="server" Text="Medium Cluster Text Size" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterLargeImage">
					<dw:TranslateLabel runat="server" Text="Large Cluster Image" /></label>
			</td>
			<td>
				<dw:FileManager id="ClustererClusterLargeImage" runat="server" Extensions="jpg,png" FullPath="true" />
			</td>
		</tr>
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterLargeTextColor">
					<dw:TranslateLabel runat="server" Text="Large Cluster Text Color" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ClustererClusterLargeTextSize">
					<dw:TranslateLabel runat="server" Text="Large Cluster Text Size" /></label>
			</td>
			<td>
		...
		<tr>
			<td class="leftColHigh">
				<label for="ListPosition">
					<dw:TranslateLabel runat="server" Text="List position" /></label>
			</td>
			<td>
...
<dw:GroupBox ID="TemplateSettings" runat="server" Title="Template" DoTranslation="true">
	<table>
		...
		<tr>
			...
			<td>
				<dw:FileManager runat="server" id="JavascriptFilename" Extensions="js" Folder="Templates/Maps/javascripts/" FullPath="True" />
			</td>
		</tr>
		<% End If%>
	</table>
...
<dw:GroupBox runat="server" ID="APISettings" Title="API Settings" DoTranslation="true">
	<table>
		<tr>
			...
			<td>
				<label>
					<input id="DisableInitScript" value="1" runat="server" type="checkbox" />
					<dw:TranslateLabel runat="server" Text="Disable injection of init script" />
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input id="DisableGoogleApi" value="1" runat="server" type="checkbox" />
					<dw:TranslateLabel runat="server" Text="Disable injection of Google Maps library" />
				</label>
			</td>
		</tr>
	</table>
...
<script type="text/javascript">/*<![CDATA[*/function ModuleMap() {
	var numberFormat = {
		numberGroupSeparator: '<%= Base.JSEnable(CurrentCulture.NumberFormat.NumberGroupSeparator) %>',
		numberDecimalSeparator: '<%= Base.JSEnable(CurrentCulture.NumberFormat.NumberDecimalSeparator) %>'
	},
	...
	document.observe('dom:loaded', function() {
		...
		setFileOption('ParagraphModuleCSS', '<%= Base.JSEnable(DefaultModuleStyleSheet) %>');
		<% End If%>
		<% If Not String.IsNullOrEmpty(DefaultModuleJavaScript) Then%>
		setFileOption('ParagraphModuleJS', '<%= Base.JSEnable(DefaultModuleJavaScript) %>');
		<% End If%>
	});
};
