...
<head runat="server">
    ...
    <script type="text/javascript">
        function help() {
	    <%=Dynamicweb.Gui.Help("", "modules.basicforms.edit")%> }
    ...
    function setlistmode(list){
        location = 'EditForm.aspx?ID=<%=Dynamicweb.Input.RequestInteger("ID")%>&listmode=' + list;
        }

        function showdata(){
            location='ListSubmits.aspx?formid=<%=Dynamicweb.Input.RequestInteger("ID")%>';
		}
...
<body>
        ...
        <dw:RibbonBar runat="server" ID="myribbon">
            <dw:RibbonBarTab Active="true" Name="Formular" runat="server">
                <dw:RibbonBarGroup runat="server" ID="toolsGroup" Name="Formular">
                    <dw:RibbonBarButton ID="cmdName" runat="server" Size="Small" Text="Settings" Image="EditGear" OnClientClick="dialog.show('settingsDialog');">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton runat="server" Text="Luk" Size="Small" Image="Cancel" ID="cmdCancel" OnClientClick="location='ListForms.aspx';" ShowWait="true" WaitTimeout="1500">
                    </dw:RibbonBarButton>
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="addFieldGroup" runat="server">
                    <dw:RibbonBarButton ID="cmdRestriction" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/Form Input (Text)_16x16.png" Text="Tekst" OnClientClick="newfield('TextInput');">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="RibbonBarButton1" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/Form Input (Textarea)_16x16.png" Text="Notat-felt" OnClientClick="newfield('Textarea');">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="RibbonBarButton3" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/Check_grey.png" Text="CheckBox" OnClientClick="newfield('CheckBox');">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="RibbonBarButton5" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/Form Input (Hidden)_16x16.png" Text="Skjult" OnClientClick="newfield('Hidden');">
                    </dw:RibbonBarButton>
                ...
                <dw:RibbonBarGroup ID="addElementGroup" runat="server">
                    <dw:RibbonBarButton ID="RibbonBarButton12" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/text_rich_colored.png" Text="Brødtekst" OnClientClick="newfield('Text');">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="RibbonBarButton10" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/image_settings.png" Text="Billede" OnClientClick="newfield('Image');">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="RibbonBarButton11" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/Label_16x16.png" Text="Mellemrum" OnClientClick="newfield('Divider');" Visible="false">
                    </dw:RibbonBarButton>
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup runat="server" ID="RibbonBarGroup1" Name="Vis">
                    <dw:RibbonBarButton ID="btnform" runat="server" Size="Small" Text="Formular" ImagePath="/Admin/Images/Ribbon/Icons/Small/form_blue.png" OnClientClick="setlistmode(false);" ShowWait="true" WaitTimeout="1500">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="btnlist" runat="server" Size="Small" Text="Liste" ImagePath="/Admin/Images/Ribbon/Icons/Small/table_selection_row.png" OnClientClick="setlistmode(true);" ShowWait="true" WaitTimeout="1500">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="btndata" runat="server" Size="Small" Text="Form data" ImagePath="/Admin/Images/Ribbon/Icons/Small/data_view.png" OnClientClick="showdata();" ShowWait="true" WaitTimeout="1500">
                    </dw:RibbonBarButton>
                </dw:RibbonBarGroup>
    ...
    <div style="overflow: auto; position: fixed; top: 135px; width: 100%; bottom: 0px;" id="main">
        <dw:Infobar runat="server" ID="noelements" Type="Information" Title="Felter" Message="" Visible="false"></dw:Infobar>
        <dw:List ID="list" ShowPaging="false" ShowTitle="false" ShowCollapseButton="false" runat="server" StretchContent="false" AllowMultiSelect="true" Visible="false">
            <Columns>
        ...
        <div id="previewformcontainer" runat="server">
            ...
            <script>
                ...
                Sortable.create('fieldList', { containment: ['fieldList'], dropOnEmpty: true, scroll: $("main"), scrollSensitivity: 100, scrollSpeed: 50, onUpdate: sortlistUpdated });
    ...
    <dw:Dialog ID="settingsDialog" runat="server" Width="540" ShowOkButton="true" OkAction="saveform();" OkText="Gem" ShowCancelButton="true" CancelAction="resetform();" ShowClose="true" IsModal="true">
    ...
    <dw:Dialog ID="newfielddialog" runat="server" Width="540" ShowOkButton="true" OkAction="savefield();" OkText="Gem" ShowCancelButton="true" CancelAction="resetfieldform();" ShowClose="true" IsModal="true">
    ...
    <dw:ContextMenu ID="EditField" runat="server">
        <dw:ContextMenuButton ID="ContextMenuButton3" runat="server" Text="Rediger" ImagePath="/Admin/Images/Ribbon/Icons/Small/Edit.png" OnClientClick="editFieldContext();" Divide="After">
        </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="ContextMenuButton4" runat="server" Text="Aktiv" ImagePath="/Admin/Images/Check.gif" OnClientClick="toggleActive();">
        </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="ContextMenuButton5" runat="server" Text="Krævet" ImagePath="/Admin/Images/Check.gif" OnClientClick="toggleRequired();" Divide="After">
        </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="ContextMenuButton1" runat="server" Text="Insert before" ImagePath="/Admin/Images/Ribbon/Icons/Small/up_plus.png" OnClientClick="addfieldbefore();">
        </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="ContextMenuButton2" runat="server" Text="Insert after" ImagePath="/Admin/Images/Ribbon/Icons/Small/down_plus.png" OnClientClick="addfieldafter();">
        </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="copyFieldBtn" runat="server" Text="Kopier felt" ImagePath="/Admin/Images/Ribbon/Icons/Small/Copy.png" OnClientClick="copyfield();" Divide="Before">
        </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="deleteFieldBtn" runat="server" Text="Slet felt" Image="Delete" OnClientClick="deleteField();" Divide="After">
        </dw:ContextMenuButton>
    </dw:ContextMenu>

    <dw:Overlay ID="wait" runat="server"></dw:Overlay>
    <script>
<%If Dynamicweb.Input.RequestInteger("scroll") > 0 Then%>
        document.getElementById("main").scrollTop = <%=Dynamicweb.Input.RequestInteger("scroll")%>;
        <%End If%>
    </script>
    <%  
