...
var main = {
    ...
    openCustomFields: function () {
        this.openInContentFrame("/Admin/Module/Common/CustomFields/CustomFields_List.aspx?context=NewsV2_general");
    },

    openCustomFieldsSpecific: function () {
        this.openInContentFrame("/Admin/Module/Common/CustomGroups/CustomGroups_List.aspx?groupContext=newsv2");
