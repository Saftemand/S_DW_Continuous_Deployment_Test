...
function addValidationGroup(group) {
    ...
    // 'Check none'-image
    cell.appendChild(createImage('/Admin/Images/CheckNone.gif', "deleteValiationGroup('" + group.Id + "');", 'Remove'));
    
    // Delete-image 
    cell.appendChild(createImage('/Admin/Images/CheckAll.gif', "checkAllValidations('" + group.Id + "');", 'Check_all_fields'));
