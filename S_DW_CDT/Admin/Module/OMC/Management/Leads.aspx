<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Content/Management/EntryContent.Master" CodeBehind="Leads.aspx.vb" Inherits="Dynamicweb.Admin.OMC.Management.Leads" %>
...
<asp:Content  ContentPlaceHolderID="MainContent" runat="server">
    <div id="PageContent" class="omc-control-panel">
        ...
        <%If Dynamicweb.Base.HasVersion("8.4.0.0") Then%>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <input type="checkbox" id="chkLeadsListKeepTemporarilyApproved" name="/Globalsettings/Modules/OMC/LeadsListKeepTemporarilyApproved" 
                                <%=Dynamicweb.Base.IIf(Dynamicweb.Base.ChkBoolean(Dynamicweb.Base.GetGs("/Globalsettings/Modules/OMC/LeadsListKeepTemporarilyApproved")), " checked='checked'", String.Empty)%>value="True" />
                        </td>
                    </tr>
                </table>
            </dw:GroupBox>
        ...
        <div class="omc-cpl-engagement" style="position: static">
            <dw:GroupBox ID="gbEngagementIndex" Title="Visitor engagement calculation" runat="server">
                ...
                <table border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" id="chkDisable" name="/Globalsettings/Modules/OMC/VisitorEngagement/Disable" onclick="OMC.ControlPanel.getInstance().onEngagementEnabledChanged(!this.checked);"
                                <%=Dynamicweb.Base.IIf(Dynamicweb.Base.ChkBoolean(Dynamicweb.Base.GetGs("/Globalsettings/Modules/OMC/VisitorEngagement/Disable")), " checked='checked'", String.Empty)%>value="True" />
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        <td colspan="2">
                            <h4 class="omc-cpl-heading"><dw:TranslateLabel ID="lbClickDepthIndex" Text="Click depth" runat="server" /></h4>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <h4 class="omc-cpl-heading"><dw:TranslateLabel ID="lbLoyalty" Text="Loyalty" runat="server" /></h4>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <h4 class="omc-cpl-heading"><dw:TranslateLabel ID="lbRecencyIndex" Text="Recency" runat="server" /></h4>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <h4 class="omc-cpl-heading"><dw:TranslateLabel ID="lbBrandIndex" Text="Branded search" runat="server" /></h4>
                        </td>
                    </tr>
                    <tr>
                        <td valign="top" style="padding-top: 4px">
                    ...
                    <tr>
                        <td colspan="2">
                            <h4 class="omc-cpl-heading"><dw:TranslateLabel ID="lbInteractions" Text="Interactions" runat="server" /></h4>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="omc-control-panel-grid-container" style="width: 425px">
                                <table class="dwGrid" cellspacing="0" cellpadding="0" border="0" style="border-style:None;width:100%;border-collapse:collapse;position: static">
                                    <tr class="header">
                                        <th scope="col" style="width: 275px"><dw:TranslateLabel ID="lbInteractionType" Text="Interaction type" runat="server" /></th>
                                        <th scope="col" style="width: 150px"><dw:TranslateLabel ID="lbInteractionPointsEarned" Text="Points earned" runat="server" /></th>
                                    </tr>
                                    <tr class="row actionRow highlightRow">
                                        <td>&nbsp;<dw:TranslateLabel ID="lbInteractionForm" Text="Submit a form" runat="server" /></td>
                                        <td>
                                    ...
                                    <tr class="row actionRow highlightRow">
                                        <td>&nbsp;<dw:TranslateLabel ID="lbInteractionOrder" Text="Place an order" runat="server" /></td>
                                        <td>
                                    ...
                                    <tr class="row actionRow highlightRow">
                                        <td>&nbsp;<dw:TranslateLabel ID="lbInteractionProduct" Text="View a product" runat="server" /></td>
                                        <td>
                                    ...
                                    <tr class="row actionRow highlightRow">
                                        <td>&nbsp;<dw:TranslateLabel ID="lbInteractionFile" Text="Download a file" runat="server" /></td>
                                        <td>
                                    ...
                                    <tr class="row actionRow highlightRow">
                                        <td>&nbsp;<dw:TranslateLabel ID="lbInteractionSearch" Text="Search for content" runat="server" /></td>
                                        <td>
                                    ...
                                    <tr class="row actionRow highlightRow">
                                        <td>&nbsp;<dw:TranslateLabel ID="lbInteractionViewNews" Text="View news item" runat="server" /></td>
                                        <td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="LeadsEmailFromName" class="std" name="/Globalsettings/Modules/OMC/LeadsEmailDefaultSettings/FromName" 
                            value="<%=Dynamicweb.Base.GetGs("/Globalsettings/Modules/OMC/LeadsEmailDefaultSettings/FromName")%>" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" id="LeadsEmailFromEmail" class="std" name="/Globalsettings/Modules/OMC/LeadsEmailDefaultSettings/FromEmail" 
                            value="<%=Dynamicweb.Base.GetGs("/Globalsettings/Modules/OMC/LeadsEmailDefaultSettings/FromEmail")%>" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                         <input type="text" id="LeadsEmailSubject" class="std" name="/Globalsettings/Modules/OMC/LeadsEmailDefaultSettings/Subject" 
                            value="<%=Dynamicweb.Base.GetGs("/Globalsettings/Modules/OMC/LeadsEmailDefaultSettings/Subject")%>" />
                    </td>
                </tr>
                <tr>
