   ...
   <div id="divValidationList" runat="server">
    <dw:List ID="lstValidationList" PageSize="15" ShowTitle="false" NoItemsMessage="No invalid emails found" runat="server" Height="360">
        <Columns>
            ...
            <dw:ListColumn ID="colSave" Name="Save" ItemAlign="Center" runat="server" />
            <dw:ListColumn ID="colClear" Name="Clear" ItemAlign="Center" runat="server" />
            <dw:ListColumn ID="colRemovePermission" Name="Remove permission" ItemAlign="Center" runat="server" />
    ...
    <div style="float: right; margin-right: 10px; margin-top:10px;">
        <dw:Button ID="btnSaveAndClose" runat="server" Name="Save and close"/>
    </div>
</div>
