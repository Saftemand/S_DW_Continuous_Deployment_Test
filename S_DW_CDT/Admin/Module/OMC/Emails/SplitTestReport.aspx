...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getScheduledDate()
        {
            ...
            {
                scheduledDate = " '" + $('dsStartDate_month').value + "-" + $('dsStartDate_day').value + "-" + $('dsStartDate_year').value + "-" + $('dsStartDate_hour').value + "-" + $('dsStartDate_minute').value + "' ";
            }
        ...
        function getConfirmText()
        {
            ...
            if(!document.getElementById("StartDate2").checked)
            {
                confirmText = '<%= Backend.Translate.JsTranslate("The e-mail ""%%"" will now be sent to the specified recipients. Do you want to continue?")%>';
            } else
            {
                confirmText = '<%= Backend.Translate.JsTranslate("The sending of e-mail ""%%"" will be scheduled for ")%>' + getScheduledDate() + '<%=Backend.Translate.JsTranslate(". Do you want to continue?")%>';
            }
            ...
            <div class="split-test-report-left">
                <dw:RoundedFrame ID="frmCommomConv" Width="440" runat="server">
                    ...
                    <asp:Panel ID="Panel3" runat="server">
                        <input id="btnSelectWinner" class="buttonSubmit" <%=If(Not IsSelectWinnerDisabled(), String.Empty, "disabled")%> onclick="showSelectWinnerDialog();" value="<%=Backend.Translate.Translate("Select a winner")%>" type="button" style="float: right; margin-left: 5px; margin-top: 10px;" />
                    </asp:Panel>
                </dw:RoundedFrame>
            </div>
