<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FoldersTree.aspx.vb" Inherits="Dynamicweb.Admin.OMC.Emails.FoldersTree" %>
...
<body>
    <form id="form1" runat="server">
        <div class="cellTreeContainer">
            <dw:Tree ID="CustomFoldersTree" runat="server" SubTitle="Custom folders" Title="Email Marketing" ShowRoot="false"
