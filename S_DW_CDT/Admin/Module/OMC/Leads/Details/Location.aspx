...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dw:PopUpWindow ID="renameLeadPopup" Title="Rename lead" ContentUrl="" AutoReload="true" 
        UseTabularLayout="true" ShowClose="true" ShowOkButton="False" Width="450" ShowCancelButton="false" 
        runat="server" HidePadding="true" TranslateTitle="true" Height="130"  />
</asp:Content>
