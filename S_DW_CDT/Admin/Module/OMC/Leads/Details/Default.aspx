    ...
    <body>
        <form id="MainForm" runat="server">
            <table id="mainTab" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr valign="top">
                    <td id="cellNavigation" style="width: 200px;">
        ...
        <script type="text/javascript">
            ...
            OMC.MasterPage.get_current().set_auth('<%=Dynamicweb.Admin.OMC.Leads.Details.EntryContent.GetAuth()%>');

            <asp:Literal ID="litMasterPageInitialization" runat="server" />

            OMC.MasterPage.get_current().initialize(function () {
                var section = '<%=Dynamicweb.Base.ChkString(MyBase.Request("Section")).Replace("'", "\'")%>';
