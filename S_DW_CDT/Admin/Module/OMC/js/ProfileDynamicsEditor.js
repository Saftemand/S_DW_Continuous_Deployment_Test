...
Dynamicweb.Controls.OMC.ProfileDynamicsEditor.prototype._initializeCache = function () {
    ...
    this._cache.choicePresetContainer = $(container.select('fieldset.omc-dynamics-edit-choice-preset')[0]);
    this._cache.choiceCreateContainer = $(container.select('fieldset.omc-dynamics-edit-choice-create')[0]);
    this._cache.choicePreset = $(container.select('fieldset.omc-dynamics-edit-choice-preset input')[0]);
    this._cache.choiceCreate = $(container.select('fieldset.omc-dynamics-edit-choice-create input')[0]);
    this._cache.choicePresetContent = $(container.select('fieldset.omc-dynamics-edit-choice-preset div.omc-dynamics-edit-choice-content')[0]);
    this._cache.choiceCreateContent = $(container.select('fieldset.omc-dynamics-edit-choice-create div.omc-dynamics-edit-choice-content')[0]);
