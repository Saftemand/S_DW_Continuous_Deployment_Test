<%@ Page CodeBehind="News_Module_Approve.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="Dynamicweb.Admin.News_Module_Approve" %>
<%@ Import namespace="Dynamicweb.Backend" %>

<%
Dim cWorkflow As Object
Dim PurgeCache() As Object
...
If LCase(Request.QueryString.Item("Immediate")) = "true" Then
	NewsCategoryID = cWorkflow.Approve("NewsCategoryID")
Else
	NewsCategoryID = cWorkflow.ApproveStep("NewsCategoryID")
End If
