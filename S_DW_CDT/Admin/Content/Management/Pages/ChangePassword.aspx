...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function showStartFrame() {
            location = '/Admin/MyPage/default.aspx';
            //history.go(-1);
        }
    </script>
</head>
<body>
    <form runat="server" id="EditUserForm" name="EditUserForm" >
        ...
        <h2 class="subtitle">
	        <dw:TranslateLabel ID="TranslateLabel1" Text="Change password" runat="server" />
        </h2>

        <dw:GroupBox ID="GroupBox1" runat="server" Title="Edit" DoTranslation="true">
            <table>
                <colgroup>
	                ...
	                <td>
	                    <div id="textPassword" style="display:none;">
	                        <table cellpadding="0" cellspacing="0">
	                            ...
	                            <tr>
	                                <td>
	                                    <label for="DoEncryptPassword"><dw:TranslateLabel ID="TranslateLabel5" runat="server" Text="Encrypt" /></label>
