        ...
        if (ticket) {
            ...
            Dynamicweb.Ajax.doPostBack({
                ...
                onComplete: function (transport, requestObject) {
                    var responseContentType = requestObject ? (requestObject.getHeader('Content-Type') + '') : '';

                    if (params.plainText || (responseContentType && responseContentType.length && responseContentType.toLowerCase().indexOf('text/plain') >= 0)) {
