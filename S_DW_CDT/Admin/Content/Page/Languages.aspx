	...
	<script type="text/javascript">
		...
		function redo(onAreaID) {
			if (confirm('<%=Dynamicweb.Backend.Translate.Translate("Gendan") %>?')) {
				...
				o.show();
				//alert("Languages.aspx?PageID=<%=Dynamicweb.Base.Request("PageID")%>&onAreaID=" + onAreaID);

				location = "Languages.aspx?PageID=<%=Dynamicweb.Base.Request("PageID")%>&onAreaID=" + onAreaID;
			}
		}
	</script>
...
<body>
	<form id="form1" runat="server">
		...
		<dw:Toolbar ID="Toolbar1" runat="server" ShowEnd="false" ShowStart="false">
			<dw:ToolbarButton ID="ToolbarButton1" runat="server" Divide="None" Image="AddDocument" Text="Gendan valgte" OnClientClick="redoSelected();">
			</dw:ToolbarButton>
		</dw:Toolbar>
		</span>
