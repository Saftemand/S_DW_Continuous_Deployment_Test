		    ...
		    <div id="EditUserDiv" style="height:100%; overflow:auto;clear:both;" runat="server">
				<dw:GroupBox ID="GroupBox1" runat="server" Title="User info" DoTranslation="true">
					<table class="EditUserTable" cellpadding="1" cellspacing="1">
                        <tr>
							<td colspan = '3' >
                                <div class="nobr"><dw:TranslateLabel ID="TranslateLabel2" runat="server" Text="Your password has expired. Please set the new password." /></div>
							</td>
						</tr>
						<tr>
							<td>
								<div class="nobr"><dw:TranslateLabel ID="TranslateLabel4" runat="server" Text="Password" /></div>
							</td>
							<td>
                        ...
                        <tr>
							<td>
								<div class="nobr"><dw:TranslateLabel ID="TranslateLabel1" runat="server" Text="Repeat Password" /></div>
							</td>
							<td>
