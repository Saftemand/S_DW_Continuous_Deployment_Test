(function (undefined) {
    ...
    if (typeof Dynamicweb.Recommendation === 'undefined') {
        Dynamicweb.Recommendation = {};
    }
    ...
    var parseQueryString = function (query) {
        ...
        getAdditionalProperties = function (product, settings) {
            var data = {};
            if (settings.ImageFolder) {
                data['ImageUrlSmall'] = getImageUrl(settings.ImageFolder + settings.ImagePatternS, product);
                data['ImageUrlMedium'] = getImageUrl(settings.ImageFolder + settings.ImagePatternM, product);
                data['ImageUrlLarge'] = getImageUrl(settings.ImageFolder + settings.ImagePatternL, product);
            }
            data['ProductDetailsUrl'] = getProductDetailsUrl(product, settings.ShowOnParagraph ? settings.ShowOnParagraph : location.pathname + location.search);
            return data;
        },
