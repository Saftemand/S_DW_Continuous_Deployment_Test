...
Dynamicweb.Area.ItemEdit.prototype.cancelChangeItemType = function () {
    ...
    // Page property item
    if (this.get_itemTypePageProperty())
        ItemTypeSelect = "ItemTypePageSelect" + this.get_itemTypePageProperty();
    else
        ItemTypeSelect = "ItemTypePageSelectdwrichselectitem";

    ItemTypeSelect = $(ItemTypeSelect);
    if (ItemTypeSelect) RichSelect.setselected(ItemTypeSelect.down("a"), "ItemTypePageSelect");
