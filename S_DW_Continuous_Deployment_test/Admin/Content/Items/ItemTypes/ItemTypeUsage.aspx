...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title></title>
        <dw:ControlResources CombineOutput="true" runat="server">
            <Items>
        ...
        <style>
            ...
            .Page_closedNew {
                background: url(/Admin/images/icons/Page_closedNew.gif) top left no-repeat;
                padding-left: 20px;
                line-height: 18px;
            }

            .Paragraph {
                background: url(/Admin/images/icons/Paragraph.gif) top left no-repeat;
                padding-left: 20px;
                line-height: 18px;
            }

            .Module_Area_small {
                background: url(/Admin/images/icons/Module_Area_small.png) top left no-repeat;
                padding-left: 20px;
                line-height: 18px;
            }
        ...
        <form id="MainForm" runat="server">
            ...
            <dw:StretchedContainer ID="OuterContainer" Scroll="Hidden" Stretch="Fill" Anchor="body" runat="server">
                <dw:Toolbar ID="Toolbar1" runat="server" ShowStart="true" ShowEnd="false">
                    <dw:ToolbarButton ID="cmdBack" Image="Undo" OnClientClick="Dynamicweb.Items.ItemTypeUsage.close();" Text="Back" runat="server" />
                    <dw:ToolbarButton ID="cmdAply" Image="Check" OnClientClick="Dynamicweb.Items.ItemTypeUsage.apply();" Text="Apply" runat="server" />
                    <dw:ToolbarButton ID="cmdHelp" Image="Help" OnClientClick="Dynamicweb.Items.ItemTypeUsage.help();" Text="Help" runat="server" Divide="Before" />
                </dw:Toolbar>
                <h2 class="subtitle">
	                <dw:TranslateLabel ID="TranslateLabel1" Text="Item type usages" runat="server" />
	            </h2>
                <dw:List ID="ItemTypeUsageList" ShowTitle="false" StretchContent="true" NoItemsMessage="No item types used" ShowPaging="true" PageSize="25" AllowMultiSelect="true" runat="server">
                    <Columns>
