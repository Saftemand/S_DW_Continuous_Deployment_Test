...
Dynamicweb.Extensibility.Editors.MultipleValuesEditor.prototype.initialize = function () {
    ...
    if (!this._initialized) {
        ...
        this._cache.list = $(this._cache.container.select('.dwe-values-list ul')[0]);
        ...
        this._cache.textboxButton = $(this._cache.container.select('.dwe-values-add a')[0]);
        ...
        this._cache.textboxButton.writeAttribute('alt', this.get_terminology().addItem || '');
...
Dynamicweb.Extensibility.Editors.MultipleValuesEditor.prototype._render = function (value, index, tryRemove) {
    ...
    if (value) {
        ...
        link.writeAttribute('alt', this.get_terminology().removeItem || '');
