...
function SortPages(ShopGroupParentID){ //Sort pages
	if(Prev){
		Prev.style.fontWeight = "";
	}
	cellObject = "";
	...
	if(document.getElementById("sort"+ShopGroupParentID).style){
		document.getElementById("sort"+ShopGroupParentID).style.fontWeight = "bold";
		Prev = document.getElementById("sort"+ShopGroupParentID);
	}
	window.ShopRight.location = "Menu_Sort.aspx?ShopGroupParentID="+ShopGroupParentID;
}
