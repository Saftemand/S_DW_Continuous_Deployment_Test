...
<head runat="server">
    <title><%=Dynamicweb.Backend.Translate.JsTranslate("Select a user")%></title>
...
<body>
    <form id="form1" runat="server" >
        <dw:List id="UserList" runat="server" PageSize="12" Title="Users" TranslateTitle="true">
            <Filters>
                <dw:ListAutomatedSearchFilter runat="server" EnableQueryExpressions="true" WaterMarkText="Search" />
