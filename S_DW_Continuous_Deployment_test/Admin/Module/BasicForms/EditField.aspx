...
<head runat="server">
	...
	<script type="text/javascript">
		function help() {
		    <%=Dynamicweb.Gui.Help("", "modules.basicforms.editfield")%>
		}
...
<body onload="document.getElementById('FormFieldName').select();">
	<form id="form1" runat="server" enableviewstate="false">
			...
			<dw:RibbonBar runat="server" ID="myribbon">
				<dw:RibbonBarTab Active="true" Name="Felt" runat="server">
					...
					<dw:RibbonBarGroup ID="settingsGroup" runat="server" Name="Indstillinger">
						<dw:RibbonBarButton ID="cmdRestriction" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/text_rich_marked.png" Text="Layout" OnClientClick="dialog.show('layoutDialog');">
						</dw:RibbonBarButton>
						<dw:RibbonBarButton ID="RibbonBarButton2" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/TextCode_edit.png" Text="Værdier" OnClientClick="dialog.show('valuesDialog');">
						</dw:RibbonBarButton>
					</dw:RibbonBarGroup>
					<dw:RibbonBarGroup ID="optionSortGroup" runat="server" Name="Valgmuligheder" Visible="false">
						<dw:RibbonBarButton ID="RibbonBarButton3" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/sort_az_descending.png" Text="Sort by text" OnClientClick="sortbytext(false);">
						</dw:RibbonBarButton>
						<dw:RibbonBarButton ID="RibbonBarButton4" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/sort_az_ascending.png" Text="Sort by text (descending)" OnClientClick="sortbytext(true);">
						</dw:RibbonBarButton>
						<dw:RibbonBarButton ID="RibbonBarButton7" runat="server" Size="Small" Text="hidden" Visible="false">
						</dw:RibbonBarButton>
						<dw:RibbonBarButton ID="RibbonBarButton5" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/sort_az_descending.png" Text="Sort by value" OnClientClick="sortbyvalue(false);">
						</dw:RibbonBarButton>
						<dw:RibbonBarButton ID="RibbonBarButton6" runat="server" Size="Small" ImagePath="/Admin/Images/Ribbon/Icons/Small/sort_az_ascending.png" Text="Sort by value (descending)" OnClientClick="sortbyvalue(true);">
						</dw:RibbonBarButton>
					</dw:RibbonBarGroup>
			...
			<dw:GroupBox ID="GB_settings" runat="server" DoTranslation="True" Title="Indstillinger">
				<table>
					...
					<tr>
						...
						<td>
							<textarea name="FormFieldDescription" id="FormFieldDescription" runat="server" cols="25" maxlength="255" class="std" onblur="updatePreview();" ></textarea>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>
							<div class="listcontainer">
								<dw:List ID="optionslist" ShowPaging="false" NoItemsMessage="" ShowTitle="false" ShowCollapseButton="false" runat="server" StretchContent="false">
									<Columns>
							...
							<button onclick="newoption();return false;"><%=Translate.Translate("Tilføj %%", "%%", Translate.Translate("valgmulighed"))%></button> <button onclick="newoption(true);return false;"><%=Translate.Translate("Tilføj %%", "%%", Translate.Translate("valgmuligheder")) %></button>
						</td>
					</tr>
				</table>
			</dw:GroupBox>
			...
			<dw:GroupBox ID="previewGroup" runat="server" DoTranslation="True" Title="Preview" Visible="false">
				<table>
					...
					<tr runat="server" visible="false">
						<td colspan="2">
							<pre runat="server" id="fieldhtml"></pre>
						</td>
					</tr>
				</table>
			</dw:GroupBox>
		...
		<dw:Dialog ID="valuesDialog" runat="server" Width="540" ShowOkButton="true" IsModal="true" Title="Værdier">
			<dw:GroupBox ID="GroupBox5" runat="server" DoTranslation="True" Title="Værdier">
				<table>
					...
					<tr>
						...
						<td>
							<%=Dynamicweb.Gui.FormFieldAutoValueSelect(FormFieldAutoValue, "FormFieldAutoValue")%>
						</td>
					</tr>
					<tr>
						<td>
		...
		<dw:Dialog ID="layoutDialog" runat="server" Width="540" ShowOkButton="true" OkAction="savelayout();" IsModal="true" Title="Layout">
	...
	<dw:Dialog ID="optionsettings" runat="server" Width="540" ShowOkButton="true" ShowCancelButton="true" IsModal="true" Title="Valgmulighed" OkAction="saveoption();">
					...
					<table>
						<tr>
							<td>
								...
								<input type="checkbox" value="true" id="FormOptionsManyDelete" name="FormOptionsManyDelete" /><label for="FormOptionsManyDelete"><dw:TranslateLabel runat="server" Text="Delete existing options" /></label>
							</td>
						</tr>
					</table>
				</dw:GroupBox>
