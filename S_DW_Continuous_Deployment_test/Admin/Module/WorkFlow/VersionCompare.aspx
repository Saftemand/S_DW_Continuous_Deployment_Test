...
<%=Gui.MakeHeaders(Translate.Translate("Versionssammenligning"), Translate.Translate("Original") & ", " & Translate.Translate("Version"), "all")%>
		...
		<td valign="top"><br>
			<DIV id="Tab1" style="Display:;">
				...
				<table border="0" cellpadding="0" width="100%">
					...
					<tr>
						<td colspan=2>
							<%=Gui.GroupBoxStart(Translate.Translate("Original"))%>
			...
			<DIV id="Tab2" style="Display:None;">
				...
				<table border="0" cellpadding="0" width="100%">
					...
					<tr>
						<td colspan=2>
							<%=Gui.GroupBoxStart(Translate.Translate("Version"))%>
							<table cellpadding=2 cellspacing=0 width="100%">
								<%=sbVFields.ToString%>
							</table>
							<%=Gui.GroupBoxEnd%>
