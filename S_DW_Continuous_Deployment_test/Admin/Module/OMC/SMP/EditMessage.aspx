...
<asp:Content ID="cHeadMessage" ContentPlaceHolderID="HeadContent" runat="server">
        <script type="text/javascript">
            ...
            String.prototype.parseURL = function () {
                    return this.replace(/<%= Me.LINK_PARSE_REGEX%>/g, function (url) {
        ...
        function SelectProductPage() {
            dialog.show('SelectProductPageDialog');
            document.getElementById("SelectProductPageFrame").src = "/Admin/Module/OMC/SMP/SelectProductPage.aspx";
        }
   ...
   <asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <dw:Toolbar ID="tbSMP" runat="server" ShowEnd="False" ShowStart="False">
           <dw:ToolbarButton ID="btnSaveNews" runat="server" Text="Save" Image="Save" />
           <dw:ToolbarButton ID="btnSaveAndCloseNews" runat="server" Text="Save and close" Image="SaveAndClose" />
           <dw:ToolbarButton ID="btnCancel" runat="server" Text="Cancel" Image="Cancel" />
           <dw:ToolbarButton ID="btnSaveAndPublish" runat="server" Text="" ImagePath="/Admin/Images/Ribbon/Icons/Small/upload.png" />
           <dw:ToolbarButton ID="btnScheduledMessage" runat="server" Text="Schedule message" Image="Clock" Visible="False" />
           <dw:ToolbarButton ID="btnHelp" runat="server" Text="Help" Image="Help" Visible="False" Divide="Before" />
       </dw:Toolbar>

       <dw:StretchedContainer ID="SMPStretchedContainer" Scroll= "Auto" Stretch="Fill" Anchor="document" runat="server" ClientIDMode="Static">
       <div id="PageContent" style="overflow: auto; min-width: 650px;">
                    ...
                    <table border="0" class="tabTableWide">
                        ...
                        <tr id="trLink" runat="server" style="display:none;">
                         ...
                         <tr id="trProductCatalogPage" runat="server">
                            ...
                            <td>
                                <input type="text" id="txPageProductCatalog" class="std field-name" runat="server" style="margin-left:0px; width: 360px;" clientidmode="Static" readonly="readonly" /> 
                                <img src="/Admin/Images/Icons/Module_eCom_Catalog_Small.gif" title="Add page with product catalog" width="16" height="16" onclick="SelectProductPage();">
                            </td>
                        </tr>
                        ...
                        <tr id="trIncludeGroup" runat="server" visible="False">
                            ...
                            <td>
                                <input type="checkbox" id="cbIncludeGroup" name="cbIncludeGroup" onchange="UpdateGroup();" />
                                <dw:TranslateLabel ID="trlIncludeGroup" Text="Include group in URL" runat="server" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td onclick="<%=Me.ClientInstanceName%>.refreshCharsCounters();" >
				                <input type="checkbox" id="cbDisableParseLinks" name="cbDisableParseLinks" runat="server" style="margin-left:0px;" clientidmode="Static" />                                
                                <dw:TranslateLabel ID="lbParseLinks" Text="Disable statistics collection on links" runat="server" />
                            </td>
                        </tr>
                                ...
                                <table class="thinTable" cellpadding="0" cellspacing="0" border="0">
                                    <tr id="trEditMainText">
                                         <td style="vertical-align:top; text-align:right;">
                                            <textarea rows="10" id="DefaultText" name="DefaultText" class="std field-description" style="height: 120px; width: 360px;" onkeyup="parseTextForLinks(this);showDefaultCharsCounter();" runat="server"></textarea>
                                            <br />
                                             <table>
                                                 <tr>
                                                     <td  nowrap="nowrap" style="width: 74%; text-align: left;">
                                                            <div id="DefaultMessageSize" class="message-chars-number">0</div>
                                                     </td>
                                                     <td style="vertical-align:top; text-align:right;">
                                                            <a class="preview-link" href="#" onclick="changeMode('trEditMainText','trViewMainText');" title="<%= Dynamicweb.Backend.Translate.Translate("Show tracked links")%>"><%= Dynamicweb.Backend.Translate.Translate("Show tracked links")%></a>
                                                     </td>
                                                 </tr>
                                             </table>
                                        </td>
                                    ...
                                    <tr id="trViewMainText" style="display:none;">
                                        <td style="vertical-align:top; text-align:right;">
                                            ...
                                            <a class="preview-link" href="#" onclick="changeMode('trViewMainText','trEditMainText');" title="<%= Dynamicweb.Backend.Translate.Translate("Hide tracked links")%>" ><%= Dynamicweb.Backend.Translate.Translate("Hide tracked links")%></a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <div id="SchedulingDiv" class="content-main">
                    <dw:GroupBox ID="GroupBox5" runat="server" Title="Setup scheduling" DoTranslation="true">
                        <table border="0">
                            ...
                            <tr>
                                <td style="padding-top: 5px;">
                                    <dw:DateSelector ID="dsStartDate" runat="server" IncludeTime="True" ShowAsLabel="False" Width="350" />
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-top: 5px;">
            ...
            <dw:Dialog runat="server" ID="showErrorsDlg" Width="600" IsModal="true" ShowClose="false" ShowOkButton="true" ShowCancelButton="false" Title="Errors found in push message">
                <table border="0" style="width: 100%;">
                    <tr>
           ...
           <dw:Dialog ID="SelectProductPageDialog" runat="server" SnapToScreen="True" Title="Select product page" HidePadding="true" Width="600">
                <iframe id="SelectProductPageFrame" style="width: 100%; height: 400px; border: solid 0px red;" src="about:blank" frameborder="0"></iframe>
           </dw:Dialog>
            ...
            <input type="hidden" id="IsPopUp" name="IsPopUp" value="<%=If(Input.RequestBoolean("popup"), "true", "false")%>" />
