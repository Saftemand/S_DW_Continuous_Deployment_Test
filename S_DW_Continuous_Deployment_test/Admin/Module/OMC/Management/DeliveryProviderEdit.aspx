...
<body>
    <form id="DeliveryProviderForm" runat="server">
        <dw:Toolbar runat="server" ShowEnd="false" ShowStart="False">
            <dw:ToolbarButton ID="cmdSave" runat="server" Disabled="false" Divide="None" Image="Save" OnClientClick="Save()" Text="Save" />
            <dw:ToolbarButton ID="cmdSaveAndClose" runat="server" Disabled="false" Divide="None" Image="SaveAndClose" OnClientClick="SaveAndClose()" Text="Save and close" />
            <dw:ToolbarButton ID="cmdCancel" runat="server" Divide="None" Image="Cancel" Text="Cancel" OnClientClick="Cancel()" />
            <dw:ToolbarButton ID="cmdDelete" runat="server" Divide="None" Image="Delete" Text="Delete" OnClientClick="Delete()" />
