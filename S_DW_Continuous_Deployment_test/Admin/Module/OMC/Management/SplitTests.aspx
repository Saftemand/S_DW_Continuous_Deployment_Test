<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Content/Management/EntryContent.Master" CodeBehind="SplitTests.aspx.vb" Inherits="Dynamicweb.Admin.OMC.Management.SplitTests" %>
    ...
    <%=Dynamicweb.Gui.WriteFolderManagerScript()%>
     ...
     <script type="text/javascript">
         ...
         function showSplitTestsList() {
             dialog.show('dglSelectSplitTests');
             document.getElementById("dglSelectSplitTestsFrame").src = "/Admin/Module/OMC/Management/SplitTestsList.aspx";
         }

        function getSplitTestsIDs() {
            var ifr = document.getElementById('dglSelectSplitTestsFrame')
                ...
                <tr>
                    ...
                    <td>
                        <div class="omc-reports-field">
                            <input type="button" id="cmdSelectReports" class="newUIbutton" value="<%=Dynamicweb.Backend.Translate.Translate("Select reports")%>" onclick="showSplitTestsList();"/>

                            <dw:Dialog ID="dglSelectSplitTests" Title="Select split test reports" TranslateTitle="true" Width="850" iframeHeight="535" IsIFrame="true" runat="server">
                            </dw:Dialog>
                            <input type="hidden" name="/Globalsettings/Modules/OMC/Notifications/SplitTestsDefinitions"  id="/Globalsettings/Modules/OMC/Notifications/SplitTestsDefinitions" value="<%=Base.ChkString(Base.GetGs("/Globalsettings/Modules/OMC/Notifications/SplitTestsDefinitions")) %>"/>
                        <div class="omc-reports-field">
                    </td>
                </tr>
            </table>
