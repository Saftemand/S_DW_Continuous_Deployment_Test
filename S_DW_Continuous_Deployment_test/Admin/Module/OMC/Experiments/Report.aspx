...
<body onload="onDocumentLoad();">
    ...
    <div id="step1Delete">
        <div class="header">
            <h1 id="title"><%= Dynamicweb.Backend.Translate.Translate("Split test report.")%></h1>
        </div>
        <div class="mainArea" style="padding:0">
			<div class="option2" style="padding-left:10px;">
                <div id="pageInfo" runat="server" visible="false" >
                    <ul style="padding-left: 0px; margin-left: 0px;">
                        <li><b><%= Dynamicweb.Backend.Translate.Translate("Page ID: ")%> </b><dw:TranslateLabel ID="labelPageID" runat="server"></dw:TranslateLabel></li>
                    </ul>
                    <ul style="padding-left: 0px; margin-left: 0px;">
                        <li><b><%= Dynamicweb.Backend.Translate.Translate("Page name: ")%></b><dw:TranslateLabel ID="labelPageName" runat="server"></dw:TranslateLabel></li>
                    </ul> 
                    <ul style="padding-left: 0px; margin-left: 0px;">
                        <li><b><%= Dynamicweb.Backend.Translate.Translate("Split test name: ")%> </b><dw:TranslateLabel ID="labelSplitTestName" runat="server"></dw:TranslateLabel></li>
                    </ul>
                </div>
                <ul style="padding-left: 0px; margin-left: 0px;">
                    <li><b><%= Dynamicweb.Backend.Translate.Translate("Split test type: ")%> </b><dw:TranslateLabel ID="labelType" runat="server"></dw:TranslateLabel></li>
                </ul>
                <ul style="padding-left: 0px; margin-left: 0px;">
                    <li><b><%= Dynamicweb.Backend.Translate.Translate("Conversion goal: ")%></b><label ID="labelGoal" runat="server" ></label></li>
                </ul> 
                <img runat="server" id="imgReport" src="/Admin/Images/Ribbon/Icons/chart.png" />
				<span  runat="server" id="linksReport"  class="links report">
					<a href="javascript:test('views');" class="active" id="linkviews"><%= Dynamicweb.Backend.Translate.Translate("Views")%></a>
					<a href="javascript:test('conversions');" class="" id="linkconversions"  runat="server" visible="false"><%= Dynamicweb.Backend.Translate.Translate("Conversions")%></a>
					<a href="javascript:test('conversionsTotal');" class="" id="linkconversionsTotal"  runat="server" visible="false"><%= Dynamicweb.Backend.Translate.Translate("Total conversion")%></a>
					<a href="javascript:test('bounceRate');" class="" id="linkbounceRate" runat="server" visible="false" ><%= Dynamicweb.Backend.Translate.Translate("Bounce rate")%></a>
					<a href="javascript:test('pageViews');" class="" id="linkpageViews" runat="server" visible="false" ><%= Dynamicweb.Backend.Translate.Translate("Page views pr. view")%></a>
					<a href="javascript:test('timeOnSite');" class="" id="linktimeOnSite" runat="server" visible="false" ><%= Dynamicweb.Backend.Translate.Translate("Time on site pr. view")%></a>
			...
			<div class="report">
				<table  runat="server" id="reportTable" border="0" cellpadding="0" cellspacing="0">
					<thead>
						<tr>
							<th class="name" style="width:150px;"><%= Dynamicweb.Backend.Translate.Translate("Variants")%></th>
							<th><%= Dynamicweb.Backend.Translate.Translate("Views")%></th>
							<th id="headerConversions" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Conversions")%></th>
							<th id="headerBounceRate" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Bounce rate (%)")%></th>
							<th id="headerPageviews" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Page views pr. view")%></th>
							<th id="headerTimespent" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Time on site pr. view")%></th>
                            <th id="headerValueOrMarkupOrder" style="display:none;" runat="server"></th>
							<th id="headerCR" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("CR (%)")%></th>
							<th><%= Dynamicweb.Backend.Translate.Translate("CR improvement")%></th>                            
                            <th id="headerAverageOrderValue" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Average Order Value")%></th>
                            <th id="headerTotalOrderValue" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Total Order Value")%></th>                            
							<th id="headerProbability" style="display:none;" runat="server"><%= Dynamicweb.Backend.Translate.Translate("Significance")%></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<div style="line-height:20px;">
								<span style="background-color:#034FB7;width:10px;height:10px;display:block;margin:5px;float:left;"></span><%= Dynamicweb.Backend.Translate.Translate("Original")%> 
							</div>
						...
						<tr>
							<td class="name" style="width:150px;">
							<div style="line-height:20px;">
								<span style="background-color:#006e12;width:10px;height:10px;display:block;margin:5px;float:left;"></span><%= Dynamicweb.Backend.Translate.Translate("Variants")%> 
							</div>
							</td>
