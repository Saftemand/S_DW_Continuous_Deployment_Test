function createSplitTestObj(pageID, noContent) {
    var obj = {
        ...
        ExperimentReport: function () {
            dialog.show('OMCExperimentDialog');
            document.getElementById("OMCExperimentDialogFrame").src = "/Admin/Module/OMC/Experiments/Report.aspx?ID=" + pageID;
        },

        ExperimentDelete: function () {
            dialog.show('OMCExperimentDialog');
            document.getElementById("OMCExperimentDialogFrame").src = "/Admin/Module/OMC/Experiments/Delete.aspx?ID=" + pageID;
        },
