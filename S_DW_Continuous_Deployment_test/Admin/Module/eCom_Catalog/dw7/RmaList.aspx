...
<asp:Content ID="Header" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <link rel="Stylesheet" type="text/css" href="css/RmaList.css" media="screen" />
    ...
    <asp:Panel runat="server" ID="ContentPanel">
            ...
            <dw:RibbonBar ID="Ribbon" runat="server">
                <dw:RibbonBarTab ID="RibbonBarTab1" Name="RMAs" runat="server">
                    <dw:RibbonBarGroup ID="RibbonBarGroup1" Name="Tools" runat="server">
                        <dw:RibbonBarButton ID="ButtonDelete" Image="DeleteDocument" Size="Small" Text="Delete"
                   ...
                   <%-- <dw:RibbonBarGroup ID="OrderStateButtonView" Name="Set RMA state" runat="server">
                    ...
                    <dw:RibbonBarGroup ID="RibbonBarGroup2" runat="server" Name="Filters">
                        <dw:RibbonBarButton runat="server" ID="ButtonReset" Text="Reset" Size="Large" ImagePath="/Admin/Module/eCom_Catalog/dw7/images/OrderList/reset.png"
                            OnClientClick="ResetFilters();" Disabled="true" />
                        <dw:RibbonBarButton runat="server" ID="ButtonApplyFilters" Text="Apply" Size="Large"
                            Image="Check" OnClientClick="javascript:List._submitForm('List');" />
                    </dw:RibbonBarGroup>
                    <dw:RibbonBarGroup ID="RibbonBarGroup4" Name="Help" runat="server">
                        <dw:RibbonBarButton ID="ButtonHelp" Image="Help" Size="Large" Text="Help" OnClientClick="help();"
                            runat="server" />
                    </dw:RibbonBarGroup>
                </dw:RibbonBarTab>
            </dw:RibbonBar>
        ...
        <div id="ListContent" style="overflow: auto;" >
            <dw:List runat="server" ID="ListOfRmas" AllowMultiSelect="true" Title="RMAs" UseCountForPaging="true"
                ...
                Personalize="true">
                <Filters>
                    <dw:ListDropDownListFilter runat="server" ID="RmaStateFilter" Label="RMA state" Width="150"
                        OnClientChange="enableResetButton();">
                        <Items>
                        </Items>
                    </dw:ListDropDownListFilter>
                    <dw:ListDropDownListFilter runat="server" ID="OpenClosedDeletedFilter" Width="150"
                    ...
                    <dw:ListDropDownListFilter runat="server" ID="TypeFilter" Width="150"
                        Label="Type" OnClientChange="enableResetButton();">
                        <Items>
                        </Items>
                    </dw:ListDropDownListFilter>

                    <dw:ListTextFilter runat="server" ID="TextSearchFilter" WaterMarkText="Search" Width="175"
                ...
                <Columns>
                    ...
                    <dw:ListColumn runat="server" ID="OrderNumber" Name="Order number"  EnableSorting="true"/>
                    <dw:ListColumn runat="server" ID="CustomerName" Name="Customer name" EnableSorting="true" />
                    ...
                    <dw:ListColumn runat="server" ID="LastChange" Name="Last change" EnableSorting="true" />
                    <dw:ListColumn runat="server" ID="CreationDate" Name="Creation date" EnableSorting="true"/>
                </Columns>
            </dw:List>
        </div>
        <!-- List end -->
...
<!-- Help button start-->
	...
	function help(){
		<%=Dynamicweb.Gui.Help("", "ecom.RmaNEW", "en") %>
	}

	window.onload = window.onresize = function() { resizeContentPane("ListContent", "Ribbon"); };
