...
productMenu.init = function (shopId, groupId, langId, allProducts) {
    this._shopId = shopId;
...
productMenu.copyProduct = function() {
    ...
    window.open("/Admin/Module/eCom_Catalog/dw7/Lists/EcomGroupSelector.aspx?CMD=GetGroupIdForCopy&MasterShopID=" + this._shopId + "&MasterGroupID=" + this._groupId + "&SetLanguageID=" + this._langId, "", "displayWindow,width=460,height=400,scrollbars=no");
}
...
productMenu.copyProductsToGroup = function (groupId) {
    ...
    new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/Edit/EcomUpdator.aspx?CMD=ProductList.CopyProducts&ToGroupID=" + groupId + "&prodCollection=" + selectedValues, {
        method: 'get',
...
productMenu.redirect = function () {
    if (productMenu._allProducts) {
        ...
        "&SmartSearchID=" + $("products_smartSearchId").value + "&ppagenumber=" + $("products_pagenumber").value +
...
productMenu.moveProduct = function () {
    ...
    window.open("/Admin/Module/eCom_Catalog/dw7/Lists/EcomGroupSelector.aspx?CMD=PickFromListGroup&MasterShopID=" + this._shopId + "&MasterGroupID=" + this._groupId + "&SetLanguageID=" + this._langId, "", "displayWindow,width=460,height=400,scrollbars=no");
}
...
productMenu.moveMultipleProducts = function () {
    ...
    this._moveFromList = true;
    window.open("/Admin/Module/eCom_Catalog/dw7/Lists/EcomGroupSelector.aspx?CMD=PickFromListGroup&MasterGroupID=" + this._groupId + "&SetLanguageID=" + this._langId, "", "displayWindow,width=460,height=400,scrollbars=no");
}
...
productMenu.attachMultipleProducts = function () {
    ...
    this._moveFromList = true;
    window.open("/Admin/Module/eCom_Catalog/dw7/Lists/EcomGroupSelector.aspx?CMD=PickFromListGroupForAttach&MasterGroupID=" + this._groupId + "&SetLanguageID=" + this._langId, "", "displayWindow,width=460,height=400,scrollbars=no");
}
...
productMenu.detachProduct = function () {
    ...
    if (this._groupId === '') {
        window.open("/Admin/Module/eCom_Catalog/dw7/Lists/EcomGroupSelector.aspx?CMD=GetGroupIdForRemove&MasterShopID=" + this._shopId + "&MasterGroupID=" + this._groupId + "&SetLanguageID=" + this._langId, "", "displayWindow,width=460,height=400,scrollbars=no");
    } else {
...
productMenu.doMoveMultipleProducts = function (groupId) {
    ...
    productMenu._refreshingGroups = groupId;
    new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/Edit/EcomUpdator.aspx?CMD=ProductList.MoveMultipleProductsFormList&ToGroupID=" + groupId + "&FromGroupID=" + this._groupId + "&prodCollection=" + selectedValues, {
        method: 'get',
        onSuccess: function (transport) {
        ...
        onSuccess: function (transport) {
            if (transport.responseText == "yes") {
                ...
                prods.each(function (p) {
                    ...
                    if (row.getStyle('color').length > 0) {
                        row.setStyle({ color: 'black' });
                    }

                    var imgIcon = document.getElementById('img' + p);
                    imgIcon.setAttribute('data-active', 'true');
                    imgIcon.src = "/Admin/images/Check.gif";
                });
        ...
        onSuccess: function (transport) {
            if (transport.responseText == "yes") {
                ...
                prods.each(function (p) {
                    ...
                    var imgIcon = document.getElementById('img' + p);
                    imgIcon.setAttribute('data-active', 'false');
                    imgIcon.src = "/Admin/images/Minus.gif";
                });
                productMenu.clearSelectedRows();
            }
        }
