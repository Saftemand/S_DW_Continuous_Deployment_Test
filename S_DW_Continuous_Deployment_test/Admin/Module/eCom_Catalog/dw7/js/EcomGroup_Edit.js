...
function AddGroupRelatedSearches() {
	FillDivLayer('LOADING', '', 'GRPSEARCHREL');

	var grpArray = document.getElementById('Form1').relatedSearchesChecked.value;
    AddDWRowFromArry("GRPSEARCHREL", globalGroupId, grpArray, "../Edit/", globalParentId, "");
}
...
function addOrderLineField(systemName, name) {
    ...
    deleteCell.innerHTML = '<a href=javascript:deleteOrderLineField(' + index + ');><img src=../images/delete_small.gif align=absmiddle title="' + globalMsgDelete + '" border=0></a>';
