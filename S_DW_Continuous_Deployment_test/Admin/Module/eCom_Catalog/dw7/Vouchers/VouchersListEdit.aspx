...
--%>    
    <script type="text/javascript">
        ...
        $(document).observe('dom:loaded', function () {
         ...
         function help() {
		        <%=Dynamicweb.Gui.Help("", "administration.managementcenter.eCommerce.productcatalog.vouchers.edit") %>
	        }
    ...
    <dw:RibbonBar ID="ListBar" runat="server">
        <dw:RibbonBarTab ID="RibbonGeneralTab" Name="List" runat="server" Visible="true">
            <dw:RibbonBarGroup ID="RibbonBarGroup1" Name="Tools" runat="server">
                ...
                <dw:RibbonBarButton ID="btnDelete" Text="Delete" Image="FolderDelete" Size="Small" runat="server" EnableServerClick="true" PerformValidation="false" OnClick="Delete_Click" />
            </dw:RibbonBarGroup>
