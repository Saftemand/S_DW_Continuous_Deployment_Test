...
<asp:Content ID="Header" ContentPlaceHolderID="HeadHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function deleteAssortment()
        {
            ...
            relationWarning = '<%=Dynamicweb.Backend.Translate.JsTranslate("There are shops/groups/products attached to the assortment. ")%>';
            <%End If%>

            <%If Me.HasUserAssotiated Then%>
            userAssociationWarning = '<%=Dynamicweb.Backend.Translate.JsTranslate("There are users/userGroups associated with the assortment. ")%>';
            <%End If%>


            if((relationWarning != '' || userAssociationWarning != '') && !confirm(relationWarning + userAssociationWarning + '<%=Dynamicweb.Backend.Translate.JsTranslate("Are you sure you want to delete?")%>'))
                return;
        ...
        function onHelp()
        {
		<%=Dynamicweb.Gui.Help("", "ecom.assortment.edit", "en") %>
        }
        ...
        function DetachItem() 
        {
            return confirm ('<%=Dynamicweb.Backend.Translate.JsTranslate("Delete?")%>');         
        }
    ...
    <dw:RibbonBar ID="Ribbon" runat="server">
        <dw:RibbonBarTab ID="RibbonbarTab1" runat="server" Active="true" Name="Assortment">
            <dw:RibbonBarGroup ID="RibbonbarGroup1" runat="server" Name="Funktioner">
                <dw:RibbonBarButton runat="server" ID="rbbSave" Text="Gem" Size="Small" Image="Save" OnClientClick="save();" />
                <dw:RibbonBarButton runat="server" ID="rbbSaveAndClose" Text="Gem og luk" Size="Small" Image="SaveAndClose" OnClientClick="saveAndClose();" />
                <dw:RibbonBarButton runat="server" ID="rbbCancel" Text="Annuller" Size="Small" Image="Cancel" OnClientClick="cancel();" />
                <dw:RibbonBarButton runat="server" ID="rbbDelete" Text="Delete" Size="Small" Image="Delete" OnClientClick="deleteAssortment();" />
            </dw:RibbonBarGroup>
            <dw:RibbonBarGroup ID="RibbonBarGroupOptions" Name="Information" runat="server" DoNotSetActive="True">
                <dw:RibbonBarRadioButton ID="rbbDetailButton" Checked="False" Text="Details"
                    Size="Small"
                    runat="server" ImagePath="/Admin/Images/Ribbon/Icons/Small/DocumentProperties.png"
            ...
            <dw:RibbonBarGroup ID="RibbonBarGroup3" Name="Attachments" runat="server" DoNotSetActive="True">
                <dw:RibbonBarRadioButton ID="rbbAttachedShopsButton" Checked="False" Text="Attached shops"
                    Size="Small"
                    runat="server" ImagePath="/Admin/Module/eCom_Catalog/dw7/images/tree/eCom_Shop_small.gif"
                ...
                <dw:RibbonBarRadioButton ID="rbbAttachedGroupsButton" Checked="False" Text="Attached groups"
                    Size="Small"
                    runat="server" ImagePath="/Admin/Module/eCom_Catalog/dw7/images/tree/eCom_Groups_small.gif"
                ...
                <dw:RibbonBarRadioButton ID="rbbAttachedProdButton" Checked="False" Text="Attached products" Size="Small"
                    runat="server" ImagePath="/Admin/Module/eCom_Catalog/dw7/images/tree/eCom_Product_small.gif"
