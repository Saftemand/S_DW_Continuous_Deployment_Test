...
<head>
    ...
    <script type="text/javascript">
        ...
        function validateEmail(sender, args) {
            ...
            if (args._item && args._item != '' && !regExp.test(args._item)) {                
                args._cancel = true;
                alert(args._item + ' ' + '<%=Translate.JsTranslate("is not correct email")%>');
            }            
        }
    </script>
</head>
                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellpadding="2" cellspacing="2" width="100%">
                                                    ...
                                                    <tr>
                                                        <td width="170">
                                                            <dw:TranslateLabel ID="TranslateLabel5" runat="server" Text="Send to customer" />
                                                        </td>
                                                        <td>
                                                            <asp:CheckBox ID="SendToCustomer" runat="server"></asp:CheckBox>                                                            
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td width="170">
