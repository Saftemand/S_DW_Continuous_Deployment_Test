...
function addProductDivContent(itemId, itemName, itemImg, container, itemObj) {
...
function TraceUpdateHidden(instanceId) {
    ...
    var radioField = "TraceRadio" + instanceId;
    var radio = document.getElementById("TraceRadio" + instanceId);
    ...
    var fileField = "TraceFile" + instanceId;
    var file = document.getElementById("TraceFile" + instanceId);
    var fileValue = "";
    if (file.value != "") {
        fileValue = file.value;
    }

    valueholder.value = '[' + radioValue + ']#;#[' + fileValue + ']';
...
function XSLTransformUpdateHidden(instanceId) {
    ...
    //Radio
    var radioField = "XSLTransformRadio" + instanceId;
    var radio = document.getElementById("XSLTransformRadio" + instanceId);
    ...
    //File   
    var fileField = "XSLTransformFile" + instanceId;
    var file = document.getElementById("XSLTransformFile" + instanceId);
    var fileValue = "";
    if (file.value != "") {
        fileValue = file.value;
    }
    ...
    //Text
    var textField = "XSLTransformTxt" + instanceId;
    var text = document.getElementById("XSLTransformTxt" + instanceId);
    var textValue = "";
    if (text.value != "") {
        textValue = text.value;
    }

    valueholder.value = '[' + radioValue + ']#;#[' + fileValue + ']#;#[' + textValue + ']';
...
function DelimiterUpdateHidden(instanceId) {
    ...
    //Radio
    var radioField = "DelimiterRadio" + instanceId;
    var radio = document.getElementById("DelimiterRadio" + instanceId);
    ...
    //Other   NOT USED ANYMORE, LDE 20/02-08
    //    var otherField = "DelimiterOther" + instanceId;
    //    var other = document.getElementById("DelimiterOther" + instanceId);
    //    var otherValue = "";
    //    if (other.value != "") {
