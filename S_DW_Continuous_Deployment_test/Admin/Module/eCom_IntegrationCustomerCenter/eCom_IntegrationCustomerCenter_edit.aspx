...
<dw:GroupBox Title="Navigation" runat="server">
	<table cellpadding="2" cellspacing="0" width="100%" border="0">
		...
		<tr style="padding-top: 10px;">
			<td valign="top"><dw:TranslateLabel ID="TranslateLabel1" runat="server" Text="Navigation template" /></td>
			<td style="white-space:nowrap;"><dw:FileManager ID="NavigationTemplate" runat="server" Name="NavigationTemplate" Folder="Templates/eCom/IntegrationCustomerCenter" FullPath="true" /></td>
		</tr>		
	</table>
</dw:GroupBox>
...
<dw:GroupBox runat="server" Title="Pages" DoTranslation="true">
    ...
    <div style="margin:5px 5px 5px 5px;">
        <a onclick="addNewPage();" title="<%=Dynamicweb.Backend.Translate.JsTranslate("Add new page")%>" >
            <span 
...
<dw:Dialog runat="server" ID="EditPageDialog" Title="Edit page settings" TranslateTitle="true" ShowCancelButton="true" ShowOkButton="true" OkAction="savePageEdit();">
    ...
    <tr>
        <td><dw:TranslateLabel ID="TranslateLabel9" runat="server" Text="Name" /></td>
        <td><input type="text" runat="server" id="PageName" name="PageName" class="NewUIinput" /></td>
    </tr>
    <tr>
		<td><dw:TranslateLabel ID="TranslateLabel2" runat="server" Text="Type" /></td>
		<td>
            <input type="text" runat="server" id="PageType" name="PageType" class="NewUIinput" />
            <div><dw:TranslateLabel runat="server" ID="LblSupportedTypes" Text="SupportedTypes" /><dw:Label runat="server" ID="PageTypes" doTranslation="False" /></div>
		</td>
	</tr>
    <tr>
        <td><dw:TranslateLabel ID="TranslateLabel26" runat="server" Text="Menu name" /></td>
        <td><input type="text" runat="server" id="PageMenuName" name="PageMenuName" class="NewUIinput" /></td>
    </tr>
    <tr>
        <td><dw:TranslateLabel ID="TranslateLabel5" runat="server" Text="Tag name" /></td>
        <td><input type="text" runat="server" id="PageTagName" name="PageTagName" class="NewUIinput" /></td>
    </tr>
	<tr>
		<td ><dw:TranslateLabel ID="TranslateLabel3" runat="server" Text="List Template" /></td>
		<td style="white-space:nowrap;"><dw:FileManager ID="PageListTemplate" runat="server" Name="PageListTemplate" Folder="Templates/eCom/IntegrationCustomerCenter" FullPath="true" /></td>			
	</tr>
	<tr>
		<td><dw:TranslateLabel ID="TranslateLabel4" runat="server" Text="Item template" /></td>
		<td style="white-space:nowrap;"><dw:FileManager ID="PageItemTemplate" runat="server" Name="PageItemTemplate" Folder="Templates/eCom/IntegrationCustomerCenter" FullPath="true" /></td>			
	</tr>	    
</table>
<br /><br />
</dw:Dialog>
...
<div id="Translate_No_PageName" style="display:none;"><dw:TranslateLabel runat="server" Text="Unnamed" /></div>
...
<script type="text/javascript">    
    ...
    //Page functions
    function Page(name, type, menuName, tagName, listTemplate, itemTemplate) {
        this.Name = name;
        this.Type = type;
    ...
    function updatePages() {
        ...
        for (var i = 0; i < pages.length; i++) {
            ...
            row.insertCell(row.cells.length).appendChild(createImage('/Admin/Module/eCom_CartV2/images/notebook_edit.png', 'editPage(' + i + ');', 'Edit'));
            if (!isMainPage(page)) {
                row.insertCell(row.cells.length).appendChild(createImage('/Admin/Module/eCom_CartV2/images/notebook_delete.png', 'deletePage(' + i + ');', 'Delete'));
            }            
        }
    }
