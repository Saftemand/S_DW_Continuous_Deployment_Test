...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function help() {
		    <%=Gui.Help("registermodule", "modules.registermodule.edit")%>
	    }
...
<body>
    ...
    <dw:StretchedContainer ID="OuterContainer" Scroll="Auto" Stretch="Fill" Anchor="document"
        ...
        <div id="Tab2" style="display:none;">
            <%=Gui.GroupBoxStart(Translate.Translate("System"))%>
            <table>
                <tr>
                    <td width="170">
            ...
            <%=Gui.GroupBoxEnd()%>
            <%=Gui.GroupBoxStart(Translate.Translate("Kategori Felter"))%>
            <table>
                <tr>
                    <td width="170">
            ...
            <%=Gui.GroupBoxEnd()%>
            <%=Gui.GroupBoxStart(Translate.Translate("Item Felter"))%>
            <table>
                <tr>
                    <td width="170">
                        <%=Translate.Translate("ID")%>
