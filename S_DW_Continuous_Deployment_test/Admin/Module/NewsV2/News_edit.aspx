...
<%@ Register TagPrefix="mc" TagName="MetaData" Src="~/Admin/Module/Metadata/EditMetadata.ascx" %>
...
<body>
    <script type="text/javascript">
        ...
        var newsID = <%=Dynamicweb.Input.RequestInteger("id").tostring() %>;
    </script>
  ...
  <div style="min-width: 500px; overflow: hidden;">
        ...
        <dw:RibbonBar ID="NewsBar" runat="server">
            <dw:RibbonBarTab ID="RibbonGeneralTab" Name="Content" runat="server" Visible="true">
                <dw:RibbonBarGroup ID="RibbonBarGroup1" Name="Tools" runat="server">
                    <dw:RibbonBarButton ID="btnSaveNews" Text="Save" Title="Save" Image="Save" Size="Small"
                        runat="server" EnableServerClick="true" OnClick="News_Save" />
                    <dw:RibbonBarButton ID="btnSaveAndCloseNews" Text="Save and close" Image="SaveAndClose"
                ...
                <dw:RibbonBarGroup ID="RibbonBarGroup5" Name="Information" runat="server">
                    <dw:RibbonBarRadioButton ID="DetailsRibbon" Text="Details" OnClientClick="ribbonTab(1);"
                        Checked="true" Group="newsGroup" Image="DocumentProperties" Size="Small" runat="server" />
                    <dw:RibbonBarRadioButton ID="CategoriesRibbon" Text="Categories" OnClientClick="ribbonTab(3);"
                        Group="newsGroup" Image="Folder" Size="Small" runat="server" />
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="RibbonBarGroup2" Name="Content" runat="server">
                    <dw:RibbonBarButton ID="PreviewButton" Text="Preview" Title="Preview" Image="Preview"
                        Size="Large" runat="server" />
                    <dw:RibbonBarButton ID="RibbonBarButton2" Text="Author" Title="Author" OnClientClick="openAuthorDialog();"
                        Image="EditDocument" Size="Small" runat="server" />
                    <dw:RibbonBarButton ID="MetaRibbon" Text="Metadata" Title="Metadata" OnClientClick="openMetaDialog();"
                        ImagePath="/admin/Images/Icons/Module_Metadata_small.gif" Size="Small" runat="server" />
					<dw:RibbonBarButton ID="commentBtn" Text="Comments" ImagePath="/Admin/Images/Ribbon/Icons/Small/star_yellow.png" Size="Small" runat="server" OnClientClick="comments(newsID);" />
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="RibbonBarGroup4" Name="Template" runat="server">
                    <dw:RibbonBarPanel ID="panelTemplates" runat="server">
                        <uc:TemplateSelector ID="selTemplates" Category="NewsV2" OnClientTemplateSelected="onTemplateSelected"
                            runat="server" ForceEnable="True"></uc:TemplateSelector>
                    </dw:RibbonBarPanel>
                </dw:RibbonBarGroup>
            ...
            <dw:RibbonBarTab ID="RibbonBarTab1" Name="Options" runat="server" Visible="true">
                <dw:RibbonBarGroup ID="RibbonBarGroup7" Name="Tools" runat="server">
                    <dw:RibbonBarButton ID="btnSaveNews1" Text="Save" Title="Save" Image="Save" Size="Small"
                        runat="server" EnableServerClick="true" OnClick="News_Save" />
                    <dw:RibbonBarButton ID="btnSaveAndCloseNews1" Text="Save and close" Image="SaveAndClose"
                        Size="Small" runat="server" EnableServerClick="true" OnClick="News_SaveAndClose" />
                    <dw:RibbonBarButton ID="RibbonBarButton9" Text="Close" Image="Cancel" Size="Small"
                ...
                <dw:RibbonBarGroup ID="RibbonBarGroup8" Name="General" runat="server">
                    ...
                    <dw:RibbonBarCheckbox ID="NewsArchive" Text="Archive" Size="Small" runat="server"
                        ImagePath="/Admin/Images/Icons/Module_NewsV2_archive.gif" />
                    <dw:RibbonBarCheckbox ID="NewsOpenNewWindow" Text="Open in new window" Size="Small"
                        runat="server" Image="WindowNew" />
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="RibbonbarGroup9" runat="server" Name="Publicering">
                    <dw:RibbonBarPanel ID="Ribbonbarpanel1" runat="server">
                        <span class="ribbonItem" style="height: 45px; margin-top: 5px;">
                            <%--<dw:TranslateLabel ID="TranslateLabel1" runat="server" Text="Valid from" /> --%><dw:DateSelector
                                runat="server" EnableViewState="false" ID="NewsValidFrom" />
                            <span style="font-size: 3px;">
                                <br />
                                <br />
                            </span>
                            <%--<dw:TranslateLabel ID="TranslateLabel22" runat="server" Text="Valid until" /> --%><dw:DateSelector
                                runat="server" EnableViewState="false" ID="NewsValidUntil" SetNeverExpire="true" />
                        </span>
                    </dw:RibbonBarPanel>
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="RibbonBarGroup11" Name="Help" runat="server">
                    <dw:RibbonBarButton ID="RibbonBarButton1" Text="Help" Title="Help" Image="Help" Size="Large"
                        runat="server" OnClientClick="help();" />
                </dw:RibbonBarGroup>
            </dw:RibbonBarTab>
            <dw:RibbonBarTab ID="NewsLetterIntegration" Name="Newsletter" runat="server" Visible="true">
                <dw:RibbonBarGroup ID="RibbonBarGroup6" Name="Tools" runat="server">
                    <dw:RibbonBarButton ID="btnSaveNews2" Text="Save" Title="Save" Image="Save" Size="Small"
                        runat="server" EnableServerClick="true" OnClick="News_Save" />
                    <dw:RibbonBarButton ID="btnSaveAndCloseNews2" Text="Save and close" Image="SaveAndClose"
                        Size="Small" runat="server" EnableServerClick="true" OnClick="News_SaveAndClose" />
                    <dw:RibbonBarButton ID="RibbonBarButton6" Text="Close" Image="Cancel" Size="Small"
                        runat="server" EnableServerClick="true" PerformValidation="false" OnClick="Cancel_Click" />
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="RibbonBarGroup3" Name="Integration" runat="server">
                    <dw:RibbonBarCheckbox ID="NewsContentSubscription" Text="Content subscription" Size="Small"
                        runat="server" ImagePath="/Admin/Images/Icons/Module_NewsletterV3_small.gif" />
                    <dw:RibbonBarCheckbox ID="NewsManualProcess" Text="Manual process" Size="Small" runat="server"
                        ImagePath="/Admin/Module/NewsLetterV3/Img/tbAddNewsletter.gif" />
                </dw:RibbonBarGroup>
                <dw:RibbonBarGroup ID="RibbonBarGroup12" Name="Help" runat="server">
                    <dw:RibbonBarButton ID="RibbonBarButton3" Text="Help" Title="Help" Image="Help" Size="Large"
                        runat="server" OnClientClick="help();" />
                </dw:RibbonBarGroup>
            </dw:RibbonBarTab>
            ...
            <dw:RibbonBarTab ID="tabMarketing" Active="false" Name="Marketing" Visible="true" runat="server">
                <dw:RibbonbarGroup ID="groupMarketingSave" Name="Tools" runat="server">
					 <dw:RibbonBarButton ID="cmdMarketingSave" Text="Save" Title="Save" Image="Save" Size="Small" runat="server" EnableServerClick="true" OnClick="News_Save" />
                    <dw:RibbonBarButton ID="cmdMarketingSaveAndClose" Text="Save and close" Image="SaveAndClose" Size="Small" runat="server" EnableServerClick="true" OnClick="News_SaveAndClose" />
                    <dw:RibbonBarButton ID="cmdMarketingCancel" Text="Close" Image="Cancel" Size="Small" runat="server" EnableServerClick="true" PerformValidation="false" OnClick="Cancel_Click" />
                </dw:RibbonbarGroup>
        ...
        <dw:Dialog ID="MetaDialog" runat="server" Title="Metadata" ShowClose="true" Width="600"
            ShowOkButton="true">
            <mc:MetaData ID="MetaData" runat="server" />
            <table border="0" cellspacing="0">
                <tr>
                    <td width="172">
                        <dw:TranslateLabel ID="TranslateLabel19" runat="server" Text="URL" />
                    </td>
                    <td>
                        <asp:TextBox ID="NewsMetaURL" runat="server" CssClass="std" Width="350" MaxLength="50"></asp:TextBox>
                    </td>
                </tr>
                 <tr>
            ...
            <div id="containerNews1">
                <div id="Tab1">
                    ...
                    <dw:GroupBoxStart runat="server" ID="GroupBoxStart1" doTranslation="true" Title="Text"
                        ToolTip="Text" />
                    <%=Gui.Editor("HtmlEditor", Integer.Parse(Base.GetGs("/Globalsettings/Settings/TextEditor/EditorWidth")), Integer.Parse(Base.GetGs("/Globalsettings/Settings/TextEditor/EditorHeight")), HtmlText, "", Nothing, "", "", Gui.EditorEdition.ForceNew)%>
                    ...
                    <table border="0" cellpadding="2" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <%= Gui.FileManager(NewsOverviewImage, Dynamicweb.Content.Management.Installation.ImagesFolderName, "NewsOverviewImage")%>
                            </td>
                        </tr>
                        <tr>
                            <td class="leftCol">
                            ...
                            <td>
                                <%= Gui.FileManager(NewsImage, Dynamicweb.Content.Management.Installation.ImagesFolderName, "NewsImage")%>
                            </td>
                        </tr>
                        <tr>
                            <td class="leftCol">
