<%@ Page CodeBehind="NewsletterExtended_Filter_Edit.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="Dynamicweb.Admin.NewsletterExtended_Filter_Edit" %>
...
<%=Gui.MakeHeaders(Translate.Translate("Filterliste"), Translate.Translate("Filterliste"), "javascript")%>
<body LEFTMARGIN="20" TOPMARGIN="16">
<%=Gui.MakeHeaders(Translate.Translate("Filterliste"), Translate.Translate("Filterliste"), "html")%>
...
<table border="0" cellpadding="0" cellspacing="0" width="600" class="tabTable">
	...
	<tr valign="bottom">
		<td colspan="4" align="right">
			<%=Gui.MakeOkCancelHelp("javascript:Send();", "location='NewsletterExtended_ListList.aspx'", True, "modules.newsletterextended.general.list.edit.filter", "newsletterV2")%>
		</td>
	</tr>
</table>
</body>
