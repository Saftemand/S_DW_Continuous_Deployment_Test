		...
		<tr>
			...
			<td>
				...
				<label for="ShowActionFolder">
					<dw:TranslateLabel ID="TranslateLabel2" runat="server" Text="Billed_mappe" /></label><br />
...
<dw:GroupBox ID="GroupBox2" runat="server" Title="Liste" DoTranslation="true">
	<table>
		...
		<tr id="PDFfileRow">
			<td style="width: 170px;">
				<dw:TranslateLabel ID="TranslateLabel11" runat="server" Text="PDF" /> (<dw:TranslateLabel ID="TranslateLabel22" runat="server" Text="Max 100 pages" />)
			</td>
			<td>
				<dw:FileManager ID="PDFfile" Name="PDFfile" runat="server" Extensions="pdf" />
			</td>
		</tr>
		<tr>
			<td style="width: 170px;">
		...
		<tr>
			<td style="width: 170px;">
				<dw:TranslateLabel ID="TranslateLabel16d" runat="server" Text="XML feed transformation XSLT" />
			</td>
			<td>
				<dw:FileManager ID="xsltFile" Name="xsltFile" runat="server" Folder="/Templates/Gallery/Xslt" Extensions="xslt,xsl" />
			</td>
		</tr>
	</table>
	<table id="ListFolderSettings">
		<tr>
			...
			<dw:RadioButton ID="SortByPictureName" runat="server" FieldName="SortBy" FieldValue="PictureName" />
				<label for="SortByPictureName">
					<dw:TranslateLabel ID="TranslateLabel5" runat="server" Text="Navn" /></label><br />
				...
				<label for="SortByPictureUpdatedDate">
					<dw:TranslateLabel ID="TranslateLabel6" runat="server" Text="Dato" /></label><br />
			</td>
		</tr>
		<tr>
			<td style="width: 170px;" valign="top">
			...
			<dw:RadioButton ID="SortOrderASC" runat="server" FieldName="SortOrder" FieldValue="ASC" />
				<label for="SortOrderASC">
					<dw:TranslateLabel ID="TranslateLabel9" runat="server" Text="Stigende" /></label><br />
					
				<dw:RadioButton ID="SortOrderDESC" runat="server" FieldName="SortOrder" FieldValue="DESC" />
				<label for="SortOrderDESC">
					<dw:TranslateLabel ID="TranslateLabel8" runat="server" Text="Faldende" /></label><br />
			</td>
		</tr>
		<tr>
			<td><dw:TranslateLabel ID="TranslateLabel19" runat="server" Text="Link til fil" /></td>
			<td><input type="text" class="std" maxlength="250" name="FileLinkText" value="<%=Properties.Value("FileLinkText")%>" /></td>
		</tr>
		<tr>
			<td><dw:TranslateLabel ID="TranslateLabel20" runat="server" Text="Besked ved tom mappe" /></td>
			<td><input type="text" class="std" maxlength="250" name="ListTextNoImages" value="<%=Properties.Value("ListTextNoImages")%>" /></td>
		</tr>
	</table>
</dw:GroupBox>
...
<dw:GroupBox ID="GroupBox7" runat="server" Title="Quality">
	<table>
		<tr>
			<td style="width: 170px;"><dw:TranslateLabel ID="TranslateLabelQuality" runat="server" Text="Quality" /></td>
            <td>
                <%= Gui.SpacListExt(Properties.Value("Quality"), "Quality", 50, 100, 1, "")%>
            </td>
		</tr>
	</table>
</dw:GroupBox>
...
<div id="ThumbnailsSettings">
    <dw:GroupBox ID="GroupBox4" runat="server" Title="Thumbnails">
	    <table>
		    <tr>
			    <td style="width: 170px;"><dw:TranslateLabel ID="TranslateLabel12" runat="server" Text="Dimensioner" /></td>
			    <td><input type="text" class="std" style="width:35px;" maxlength="4" name="MaxThumbWidth" id="MaxThumbWidth" value="<%=properties.Value("MaxThumbWidth")%>" /><Label for="MaxThumbWidth">&nbsp;<dw:TranslateLabel ID="TranslateLabel13" runat="server" Text="Max bredde (px)" /></Label></td>
		    </tr>
		    <tr>
			    <td>&nbsp;</td>
			    <td><input type="text" class="std" style="width:35px;" maxlength="4" name="MaxThumbHeight" id="MaxThumbHeight" value="<%=properties.Value("MaxThumbHeight")%>" /><Label for="MaxThumbHeight">&nbsp;<dw:TranslateLabel ID="TranslateLabel14" runat="server" Text="Max højde (px)" /></Label></td>
		    </tr>
	    </table>
    </dw:GroupBox>
</div>
...
<dw:GroupBox ID="GroupBox5" runat="server" Title="Billede">
	<table>
		<tr>
			<td style="width: 170px;"><dw:TranslateLabel ID="TranslateLabel16" runat="server" Text="Dimensioner" /></td>
			<td><input type="text" class="std" style="width:35px;" maxlength="4" name="MaxPictureWidth" id="MaxPictureWidth" value="<%=properties.Value("MaxPictureWidth")%>" /><Label for="MaxPictureWidth">&nbsp;<dw:TranslateLabel ID="TranslateLabel17" runat="server" Text="Max bredde (px)" /></Label></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><input type="text" class="std" style="width:35px;" maxlength="4" name="MaxPictureHeight" id="MaxPictureHeight" value="<%=properties.Value("MaxPictureHeight")%>" /><Label for="MaxPictureHeight">&nbsp;<dw:TranslateLabel ID="TranslateLabel18" runat="server" Text="Max højde (px)" /></Label></td>
		</tr>
	</table>
</dw:GroupBox>
...
<dw:GroupBox ID="GroupBox3" runat="server" Title="Sideindeling">
	<table>
		<tr>
			...
			<td><%=Gui.SpacListExt(Properties.Value("PageSize"), "PageSize", 1, 200, 1, "")%></td>
		</tr>
		<tr>
		...
		<tr>
			<td valign="top"><%=Translate.Translate("%% knap", "%%", "<em>" & Translate.Translate("Tilbage") & "</em>" )%></td>
