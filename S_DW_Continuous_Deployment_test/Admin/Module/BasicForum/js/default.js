...
var menuActions = {
    ...
    activateCategoryMenu: function (activate) {
        var categoryId = ContextMenu.callingID;
        window.open("Default.aspx?CategoryID=" + categoryId + "&Activate=" + activate, "ContentFrame");
    },
    ...
    deleteCategory: function () {
        ...
        if (confirm(confirmMessage)) {
            ...
            window.open("PerformForumAction.ashx?cmd=category&CategoryID=" + categoryId, "ContentFrame");
