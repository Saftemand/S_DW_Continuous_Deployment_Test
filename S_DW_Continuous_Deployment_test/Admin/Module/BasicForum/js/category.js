var forumCategory = {
    ...
    activateCategoryMenu: function (activate) {
        ...
        window.parent.open("PerformForumAction.ashx?cmd=categoryactivate&CategoryID=" + categoryId + "&Activate=" + activate, "ContentFrame");
    },
    ...
    deleteCategoryRibbon: function (categoryId) {
        ...
        if (confirm(confirmMessage)) {
            window.parent.open("PerformForumAction.ashx?cmd=category&CategoryID=" + categoryId, "ContentFrame");
        }
    },
    ...
    permissions: function (categoryId) {
        ...
        if (typeof (dialog) == 'undefined') {
            ...
            dialogIfarme = window.parent.document.getElementById('permissionEditDialogIFrame');
        }
        else {
            d = dialog;
            dialogIfarme = document.getElementById('permissionEditDialogIFrame');
        }
