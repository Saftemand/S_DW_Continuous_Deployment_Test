...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript" src="js/listThreads.js"></script>
    <script type="text/javascript">
     function help() {
		    <%=Dynamicweb.Gui.Help("", "modules.dw8.forum.general.thread.list") %>
	    }
...
<form runat=server >
    <dw:Toolbar ID="Toolbar1" runat="server" ShowEnd="false">
        <dw:ToolbarButton ID="NewThreadToolBar" runat="server" Divide="None" Image="AddDocument" Text="New thread" OnClientClick="" ></dw:ToolbarButton>
        <dw:ToolbarButton ID="EditCategoryToolBar" runat="server" Divide="None" Image="FolderEdit" Text="Edit category" OnClientClick="menuActions.editCategory();" ></dw:ToolbarButton>
        <dw:ToolbarButton ID="CategoriesToolBar" runat="server" Divide="None" Image="Folder" Text="Categories" OnClientClick="message.listCategory();" ></dw:ToolbarButton>
    ...
    <dw:List ID="List1" runat="server" TranslateTitle="false" Title="Threads" PageSize="25" StretchContent="true" >
        <Filters>
    ...
    <dw:ContextMenu ID="ThreadContextMenu" runat="server" OnClientSelectView="listThreads.listControl.contextMenuView" >
        <dw:ContextMenuButton ID="EditThreadBtn" runat="server" Divide="After" Image="EditDocument" Text="Edit thread" Views="unsticky,sticky" > </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="UnstickyThreadBtn" runat="server" Divide="None" Image="PaperClipDelete" Text="UnStick" Views="unsticky" > </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="StickyThreadBtn" runat="server" Divide="None" Image="PaperClipAdd" Text="Sticky" Views="sticky" > </dw:ContextMenuButton>
        <dw:ContextMenuButton ID="DeleteThreadBtn" runat="server" Divide="Before" Image="DeleteDocument" Text="Delete thread" Views="unsticky,sticky" > </dw:ContextMenuButton>
    </dw:ContextMenu>
