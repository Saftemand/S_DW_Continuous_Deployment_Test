var mails = new Array();
function Mail(recipient, subject, template, templatePath, senderName, senderMail, isCustomer, encodingCodePage, attachment, attachmentPath) {
...
function addNewMail() {
    mails.push(new Mail('', '', '', '', '', '', false, 65001, '', '')); // 65001 is the codepage for UTF-8
    updateMails();
