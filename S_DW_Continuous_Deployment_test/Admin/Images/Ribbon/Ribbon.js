...
var Ribbon = {
    ...
    tab: function (activeID, ribbonID) {
        ...
        if (document.getElementById("tabarea" + activeID)) {
            document.getElementById("tabarea" + activeID).style.display = "";
        }
    ...
    isChecked: function (id) {
        ...
        if (elm)
            ret = elm.value.toLowerCase() == 'true';
    ...
    radioButtonClick: function (e, id, uniqueID, groupName, onClientClick) {
    ...
    toggleCollapsed: function (controlID) {
        /// <summary>Toggles the "collapsed" state of the Ribbon.</summary>
        /// <param name="controlID">Ribbon control ID.</param>

        Ribbon.setIsCollapsed(controlID, !Ribbon.isCollapsed(controlID));
    },

    setIsCollapsed: function (controlID, isCollapsed) {
                ...
                if (children && children.length) {
                    for (var i = 0; i < children.length; i++) {
                        ...
                        if (tag) {
                            ...
                            if (tag == 'img') {
                                children[i].src = isCollapsed ? '/Admin/Images/Ribbon/expand.png' : '/Admin/Images/Ribbon/collapse.png';
                                break;
                            }
                        }
                    }
