...
Dynamicweb.Controls.CustomSelector.UnderlyingControl.prototype.reset = function () {
    if (this._initialized) {
        ...
        this._container.removeChild(this._buttonGroup);

        this._buttonGroup.removeChild(this._addButon);
        this._buttonGroup.removeChild(this._removeButton);
...
Dynamicweb.Controls.CustomSelector.UnderlyingControl.prototype.set_isEnabled = function (value) {
    ...
    if (value) {
        ...
        doc.removeClass(this._addButton, 'custom-selector-btn-disabled');
        doc.removeClass(this._removeButton, 'custom-selector-btn-disabled');
    } else {
        doc.attribute(this._input, "disabled", true);
        doc.addClass(this._addButton, 'custom-selector-btn-disabled');
        doc.addClass(this._removeButton, 'custom-selector-btn-disabled');
    }
};
...
Dynamicweb.Controls.CustomSelector.UnderlyingControl.prototype.initialize = function (parameters) {
    ...
    if (!this._initialized) {
        ...
        this._removeButton = ajaxDoc.createElement('span', {
            ...
            'class': 'custom-selector-btn custom-selector-btn-remove'
        });

        this._addButton = ajaxDoc.createElement('span', {
            'title': parameters.addTitle || 'Add',
            'class': 'custom-selector-btn custom-selector-btn-add'
        });

        this._buttonGroup = ajaxDoc.createElement('div', {
            'class': 'custom-selector-buttons'
        });

        this._input = ajaxDoc.createElement('input', {
            'type': 'text',
            'readonly': 'readonly',
            'class': 'custom-selector-text'
        });

        this._container = ajaxDoc.createElement('div', {
            'class': 'custom-selector-field'
        });

        this._buttonGroup.appendChild(this._addButton);
        this._buttonGroup.appendChild(this._removeButton);

        this._container.appendChild(this._input);
        this._container.appendChild(this._buttonGroup);
