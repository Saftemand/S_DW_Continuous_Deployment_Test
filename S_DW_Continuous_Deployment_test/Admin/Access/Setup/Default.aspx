				...
				<div id="boxinner">
					...
					<div id="header">
						...
						<div id="logocontainer">
							<img src="../DW_logo_200.png" style="width: 200px;" alt="Dynamicweb 8 CMS" />
						</div>
					</div>
					...
					<div id="step3" class="step">
						...
						<div id="databasesetupoptions">
							...
							<div>
								<label>
									<input type="radio" name="dboption" id="dboptionsql" value="sql" checked="checked" onchange="dboptions()" />SQL-Server database (2008 or 2012)<br />
								...
								<table>
									...
									<tr id="dbcreateazuredatabaserow">
										...
										<td>
											...
											<label for="dbcreateazuredatabase">Create database if it does not exist.</label>
										</td>
									</tr>
					...
					<div id="step4" class="step">
						...
						<div>
							<input type="checkbox" name="licenseaccept" id="licenseaccept" value="True" /><label for="licenseaccept">I accept the license terms, <a href="http://www.dynamicweb.com/terms">http://www.dynamicweb.com/terms</a></label>
						</div>
